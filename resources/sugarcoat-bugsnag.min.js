{
    ...
    (function () {
        !function (e) {
            ...
            var it = function () {
                    const $___old_5eb1f1dda2c2d0d5 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_5eb1f1dda2c2d0d5)
                        ...
                        if ($___old_5eb1f1dda2c2d0d5)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_5eb1f1dda2c2d0d5));
                    }
                }, ot = function () {
                    if ('fetch' in window) {
                        var e = window.fetch;
            ...
            var Tt = function (e, t, n) {
                    ...
                    sendSession: function (e, t, n) {
                        const $___old_4b1d490a132db2bc = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_e2a55fc1fd6d4a23 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                        try {
                            if ($___old_4b1d490a132db2bc)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_b3615e3d24fb9d30.XMLHttpRequest));
                            if ($___old_e2a55fc1fd6d4a23)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_b3615e3d24fb9d30.XMLHttpRequest));
                            return function () {
                                var r = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {
                                };
                                try {
                                    ...
                                    o.onreadystatechange = function () {
                                        const $___old_4bbd3f1064495bf6 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                        try {
                                            if ($___old_4bbd3f1064495bf6)
                                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_b3615e3d24fb9d30.XMLHttpRequest));
                                            return function () {
                                                o.readyState === window.XMLHttpRequest.DONE && r(null, o.responseText);
                                            }.apply(this, arguments);
                                            ...
                                            if ($___old_4bbd3f1064495bf6)
                                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_4bbd3f1064495bf6));
                                        }
                            ...
                            if ($___old_4b1d490a132db2bc)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_4b1d490a132db2bc));
                            if ($___old_e2a55fc1fd6d4a23)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_e2a55fc1fd6d4a23));
                        }
                    }
