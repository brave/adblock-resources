            ...
            (function () {
                ...
                f.ensureModuleRegistered('SignalsEventValidation', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsLogging'), b = a.logUserError, c = /^[+-]?\d+(\.\d+)?$/, d = 'number', e = 'currency_code', g = {
                                    AED: 1,
                                    ARS: 1,
                                    AUD: 1,
                                    BOB: 1,
                ...
                f.ensureModuleRegistered('SignalsFBEventsBatcher', function () {
                    return function (g, i, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsConfigStore'), b = 1000, c = 10;
                            function d() {
                ...
                f.ensureModuleRegistered('signalsFBEventsCoerceBatchingConfig', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsTyped'), b = a.Typed, c = a.coerce, d = a.enforce, e = function (a) {
                ...
                f.ensureModuleRegistered('signalsFBEventsCoerceParameterExtractors', function () {
                    return function (g, h, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsUtils'), b = a.filter, c = a.map, d = f.getFbeventsModules('signalsFBEventsCoerceStandardParameter');
                            function e(a) {
                ...
                f.ensureModuleRegistered('SignalsFBEventsConfigLoadedEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('signalsFBEventsCoercePixelID');
                            function c(a) {
                                a = b(a);
                                ...
                                h(b, [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (b) {
                                            ...
                                            if (b == null)
                                                return;
                                            var c = b.config, d = b.experimentName, e = b.pixelID;
                                            b = b.pluginName;
                    ...
                    return function (g, i, j, k) {
                        ...
                        (function () {
                            ...
                            var a = Object.assign || function (a) {
                                    ...
                                    return a;
                                }, b = f.getFbeventsModules('SignalsEventValidation'), c = f.getFbeventsModules('SignalsFBEventsConfigStore'), d = f.getFbeventsModules('SignalsFBEventsEvents'), e = d.configLoaded, k = f.getFbeventsModules('SignalsFBEventsFireLock'), o = f.getFbeventsModules('SignalsFBEventsJSLoader');
                            d = f.getFbeventsModules('SignalsFBEventsLogging');
                            var p = f.getFbeventsModules('SignalsFBEventsOptIn'), q = f.getFbeventsModules('SignalsFBEventsUtils'), r = f.getFbeventsModules('signalsFBEventsGetIsIosInAppBrowser'), s = f.getFbeventsModules('signalsFBEventsSendEvent'), t = q.each, u = q.keys, v = q.map, w = q.some, x = d.logError, y = d.logUserError, z = {
                                    AutomaticMatching: !0,
                                ...
                                h(d, [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (a) {
                                            ...
                                            var c = a.customParameters, d = '';
                                            c && c.es && typeof c.es === 'string' && (d = c.es);
                                            var e = this.fbq.getEventCustomParameters(this.getPixel(a.pixelId), a.eventName, a.customData, d), f = a.eventData.eventID;
                                            e.append('eid', f);
                                            c && t(u(c), function (a) {
                                                if (e.containsKey(a))
                    ...
                    return function (g, h, j, k) {
                        ...
                        (function () {
                            ...
                            var a = Object.assign || function (a) {
                                    ...
                                    return a;
                                }, b = f.getFbeventsModules('SignalsFBEventsBaseEvent'), c = f.getFbeventsModules('SignalsParamList');
                            function d(b, d, e) {
                                var f = null;
                ...
                f.ensureModuleRegistered('SignalsFBEventsGetCustomParametersEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsFBEventsPixelTypedef'), c = f.getFbeventsModules('SignalsFBEventsTyped'), d = c.Typed, e = c.coerce;
                            function g(a, c, f, g) {
                                a = e(a, b);
                                c = e(c, d.string());
                ...
                f.ensureModuleRegistered('signalsFBEventsGetIsChrome', function () {
                    return function (f, g, h, i) {
                        ...
                        (function () {
                            'use strict';
                            function a() {
                                var a = f.chrome, b = f.navigator, c = b.vendor, d = f.opr !== void 0, e = b.userAgent.indexOf('Edge') > -1;
                ...
                f.ensureModuleRegistered('signalsFBEventsGetIsIosInAppBrowser', function () {
                    return function (f, g, h, i) {
                        ...
                        (function () {
                            'use strict';
                            function a() {
                                var a = f.navigator, b = a.userAgent.indexOf('AppleWebKit'), c = a.userAgent.indexOf('FBIOS'), d = a.userAgent.indexOf('Instagram');
                ...
                f.ensureModuleRegistered('SignalsFBEventsGetIWLParametersEvent', function () {
                    return function (g, h, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsConvertNodeToHTMLElement'), c = f.getFbeventsModules('SignalsFBEventsPixelTypedef'), d = f.getFbeventsModules('SignalsFBEventsTyped'), e = d.coerce;
                            function g() {
                                ...
                                if (g == null || (typeof g === 'undefined' ? 'undefined' : i(g)) !== 'object')
                                    return null;
                                var h = g.unsafePixel, j = g.unsafeTarget, k = e(h, c), l = j instanceof Node ? b(j) : null;
                        ...
                        (function () {
                            ...
                            function c() {
                                ...
                                if (e == null || (typeof e === 'undefined' ? 'undefined' : i(e)) !== 'object')
                                    return null;
                                var f = e.graphToken, g = e.pixelID, h = b(g);
                ...
                f.ensureModuleRegistered('SignalsFBEventsLogging', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsUtils'), b = a.isArray, c = a.isInstanceOf, d = a.map, e = f.getFbeventsModules('SignalsParamList'), h = f.getFbeventsModules('signalsFBEventsSendGET'), i = f.getFbeventsModules('SignalsFBEventsJSLoader'), j = !1;
                            function l() {
                                j = !0;
                            }
                            var m = !0;
                            ...
                            var x = 'Facebook Pixel Error', y = function () {
                            ...
                            function D(a, b) {
                                try {
                                    ...
                                    if (d != null && d.dataPrivacyOptions.includes('LDU'))
                                        return;
                                    d = Math.random();
                ...
                f.ensureModuleRegistered('SignalsFBEventsMobileAppBridge', function () {
                    return function (g, h, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsTelemetry'), b = f.getFbeventsModules('SignalsFBEventsUtils'), c = b.each, d = 'fbmq-0.1', e = {
                ...
                f.ensureModuleRegistered('SignalsFBEventsOptIn', function () {
                    return function (g, i, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsUtils'), b = a.each, c = a.filter, d = a.keys, e = a.some;
                            function g(a) {
                                b(d(a), function (b) {
                                    if (e(a[b], function (b) {
                ...
                f.ensureModuleRegistered('SignalsFBEventsPCMInstagramTriggerAttributionConfigTypedef', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            ...
                            var a = f.getFbeventsModules('SignalsFBEventsTyped');
                            a = a.Typed;
                            a = a.objectWithFields({ pcmInstagramTriggerAttributionURL: a.string() });
                            k.exports = a;
                        }());
                        return k.exports;
                    }(a, b, c, d);
                ...
                f.ensureModuleRegistered('SignalsFBEventsPIIAutomatchedEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsFBEventsPixelTypedef'), c = f.getFbeventsModules('SignalsFBEventsTyped'), d = c.coerce;
                            function e(a) {
                                a = d(a, b);
                                return a != null ? [a] : null;
                            }
                ...
                f.ensureModuleRegistered('SignalsFBEventsPluginManager', function () {
                    return function (g, j, k, l) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsConfigStore'), b = f.getFbeventsModules('SignalsFBEventsEvents'), c = b.pluginLoaded, d = f.getFbeventsModules('SignalsFBEventsJSLoader');
                            b = f.getFbeventsModules('SignalsFBEventsLogging');
                            var e = b.logError, g = f.getFbeventsModules('SignalsFBEventsPlugin');
                            function j(a) {
                ...
                f.ensureModuleRegistered('SignalsFBEventsQE', function () {
                    return function (i, j, k, l) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsExperimentsTypedef'), b = f.getFbeventsModules('SignalsFBEventsLegacyExperimentGroupsTypedef'), c = f.getFbeventsModules('SignalsFBEventsTypeVersioning'), d = f.getFbeventsModules('SignalsFBEventsTyped'), e = d.coerce;
                            d = f.getFbeventsModules('SignalsFBEventsUtils');
                            var i = d.reduce, j = function () {
                                    return Math.random();
                                };
                            function k(a) {
                                ...
                                for (var d = 0; d < a.length; d++) {
                                    var e = a[d], f = e.passRate, h = e.code;
                                    e = e.name;
                                    var k = g(b[d], 2), l = k[0];
                                    k = k[1];
                                    if (c >= l && c < k) {
                ...
                f.ensureModuleRegistered('signalsFBEventsSendBatch', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBatcher'), b = f.getFbeventsModules('SignalsFBEventsLogging'), c = b.logError;
                            b = f.getFbeventsModules('SignalsFBEventsUtils');
                            var d = b.map, e = f.getFbeventsModules('SignalsParamList'), h = f.getFbeventsModules('signalsFBEventsSendBeacon'), i = f.getFbeventsModules('signalsFBEventsSendGET'), j = f.getFbeventsModules('signalsFBEventsSendXHR');
                            function l(a) {
                                a = d(a, function (a) {
                ...
                f.ensureModuleRegistered('signalsFBEventsSendBeacon', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsQE'), b = f.getFbeventsModules('SignalsFBEventsNetworkConfig'), c = f.getFbeventsModules('SignalsFBEventsExperimentNames'), d = c.SEND_BEACON_STRING_EXPERIMENT;
                            function e(c, e) {
                ...
                f.ensureModuleRegistered('SignalsFBEventsSendEventEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsParamList');
                            f.getFbeventsModules('SignalsFBEventsPixelTypedef');
                            var c = f.getFbeventsModules('SignalsFBEventsTyped'), d = c.Typed;
                            c.coerce;
                ...
                f.ensureModuleRegistered('signalsFBEventsSendFormPOST', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsNetworkConfig'), b = f.getFbeventsModules('SignalsFBEventsUtils'), c = b.listenOnce;
                            function d(b, d) {
                ...
                f.ensureModuleRegistered('signalsFBEventsSendGET', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            ...
                            function c(c, d) {
                                var e = d || {}, f = e.ignoreRequestLengthCheck;
                                f = f === void 0 ? !1 : f;
                                e = e.url;
                ...
                f.ensureModuleRegistered('signalsFBEventsSendXHR', function () {
                    return function (g, h, i, j) {
                        ...
                        k.exports;
                        (function () {
                            const $___old_b76ad155a441a984 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_aa8158cad4b5646a = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                            try {
                                if ($___old_b76ad155a441a984)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_03bfffe61b3e94f4.XMLHttpRequest));
                                if ($___old_aa8158cad4b5646a)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_03bfffe61b3e94f4.XMLHttpRequest));
                                return function () {
                                    'use strict';
                                    var a = f.getFbeventsModules('SignalsFBEventsNetworkConfig'), b = f.getFbeventsModules('SignalsParamList'), c = f.getFbeventsModules('SignalsFBEventsLogging'), d = c.logError, e = {
                                            UNSENT: 0,
                                            OPENED: 1,
                                            HEADERS_RECEIVED: 2,
                                            LOADING: 3,
                                    ...
                                    function i(c) {
                                        var d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : a.ENDPOINT, e = arguments[2];
                                        if (!g)
                                            return !1;
                                ...
                                if ($___old_b76ad155a441a984)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b76ad155a441a984));
                                if ($___old_aa8158cad4b5646a)
                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_aa8158cad4b5646a));
                            }
                        }());
                        return k.exports;
                    }(a, b, c, d);
                ...
                f.ensureModuleRegistered('SignalsFBEventsSetEventIDEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsParamList'), c = f.getFbeventsModules('SignalsFBEventsPixelTypedef'), d = f.getFbeventsModules('SignalsFBEventsTyped'), e = d.coerce;
                            function g(a, d) {
                                a = e(a, c);
                ...
                f.ensureModuleRegistered('SignalsFBEventsSetIWLExtractorsEvent', function () {
                    return function (g, h, j, k) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsFBEventsUtils'), c = b.filter, d = b.map, e = f.getFbeventsModules('signalsFBEventsCoerceParameterExtractors'), g = f.getFbeventsModules('signalsFBEventsCoercePixelID');
                            function h() {
                                ...
                                if (h == null || (typeof h === 'undefined' ? 'undefined' : i(h)) !== 'object')
                                    return null;
                                var j = h.pixelID, k = h.extractors, l = g(j), m = Array.isArray(k) ? d(k, e) : null, n = m != null ? c(m, Boolean) : null;
                ...
                f.ensureModuleRegistered('SignalsFBEventsTelemetry', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsLogging'), b = f.getFbeventsModules('SignalsParamList');
                            ...
                            d = 0.01;
                            var e = Math.random(), h = g.fbq && g.fbq._releaseSegment ? g.fbq._releaseSegment : 'unknown', i = e < d || h === 'canary', j = 'https://connect.facebook.net/log/fbevents_telemetry/';
                            function l(d) {
                                var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, f = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
                                if (!f && !i)
                                    return;
                                try {
                                    var k = new b(null);
                ...
                f.ensureModuleRegistered('SignalsFBEventsUtils', function () {
                    return function (f, g, j, k) {
                        ...
                        (function () {
                            ...
                            var q = Object.prototype.hasOwnProperty, r = !{ toString: null }.propertyIsEnumerable('toString'), s = [
                                    'toString',
                                    'toLocaleString',
                                    'valueOf',
                                    'hasOwnProperty',
                ...
                f.ensureModuleRegistered('SignalsFBEventsValidateCustomParametersEvent', function () {
                    return function (g, h, i, j) {
                        ...
                        (function () {
                            'use strict';
                            var a = f.getFbeventsModules('SignalsFBEventsBaseEvent'), b = f.getFbeventsModules('SignalsFBEventsTyped'), c = b.coerce, d = b.Typed, e = f.getFbeventsModules('SignalsFBEventsPixelTypedef');
            ...
            (function () {
                ...
                f.ensureModuleRegistered('signalsFBEventsGetTier', function () {
                    return function (f, b, c, d) {
                        ...
                        (function () {
                            'use strict';
                            var a = /^https:\/\/www\.([A-Za-z0-9\.]+)\.facebook\.com\/tr\/?$/, b = [
                ...
                f.ensureModuleRegistered('SignalsFBEvents.plugins.iwlbootstrapper', function () {
                    return function (a, b, c, d) {
                        ...
                        e.exports;
                        (function () {
                            const $___old_b199a987a9acab65 = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                            try {
                                if ($___old_b199a987a9acab65)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_5681dcac222e7c62.sessionStorage));
                                return function () {
                                    'use strict';
                                    var c = f.getFbeventsModules('SignalsFBEventsIWLBootStrapEvent'), d = f.getFbeventsModules('SignalsFBEventsLogging'), g = f.getFbeventsModules('SignalsFBEventsNetworkConfig'), h = f.getFbeventsModules('SignalsFBEventsPlugin'), i = f.getFbeventsModules('signalsFBEventsGetIwlUrl'), j = f.getFbeventsModules('signalsFBEventsGetTier'), k = d.logUserError, l = /^https:\/\/.*\.facebook\.com$/i, m = 'FACEBOOK_IWL_CONFIG_STORAGE_KEY', n = a.sessionStorage ? a.sessionStorage : {
                                            getItem: function (a) {
                                                return null;
                                            },
                                    ...
                                    e.exports = new h(function (d, e) {
                                        ...
                                        function q() {
                                            ...
                                            if (!b)
                                                return;
                                            b = JSON.parse(b);
                                            var c = b.pixelID, d = b.graphToken, e = b.sessionStartTime;
                                            o = !0;
                                            h(c, function () {
                                                var b = p(c) ? c : null;
                                        ...
                                        function d(a) {
                                            var b = a.data, c = b.graphToken, d = b.msg_type, f = b.pixelID;
                                ...
                                if ($___old_b199a987a9acab65)
                                    ({}.constructor.defineProperty(window, 'sessionStorage', $___old_b199a987a9acab65));
                            }
                        }());
                        return e.exports;
                    }(a, b, c, d);
            ...
            (function () {
                ...
                f.ensureModuleRegistered('SignalsFBEvents.plugins.opttracking', function () {
                    return function (a, b, c, d) {
                        ...
                        (function () {
                            'use strict';
                            var b = f.getFbeventsModules('SignalsFBEventsEvents'), c = b.getCustomParameters, d = b.piiAutomatched, g = b.piiConflicting, h = b.piiInvalidated, i = f.getFbeventsModules('SignalsFBEventsOptTrackingOptions');
                            b = f.getFbeventsModules('SignalsFBEventsPlugin');
                            var j = f.getFbeventsModules('SignalsFBEventsProxyState'), k = f.getFbeventsModules('SignalsFBEventsUtils'), l = k.some, m = !1;
                            function n() {
                                try {
                            ...
                            k = new b(function (a, b) {
                                ...
                                c.listen(function (c) {
                                    var d = b.optIns, f = p(c != null && d.isOptedOut(c.id, 'AutomaticSetup'), i.AUTO_CONFIG_OPT_OUT);
                                    d = p(c != null && d.isOptedIn(c.id, 'AutomaticSetup'), i.AUTO_CONFIG);
                                    var g = p(a.disableConfigLoading !== !0, i.CONFIG_LOADING), h = p(n(), i.SUPPORTS_DEFINE_PROPERTY), m = p(o(), i.SUPPORTS_SEND_BEACON), q = p(c != null && k[c.id], i.HAS_CONFLICTING_PII), r = p(c != null && e[c.id], i.HAS_INVALIDATED_PII);
                                    c = p(c != null && l[c.id], i.HAS_AUTOMATCHED_PII);
                                    var s = p(j.getShouldProxy(), i.SHOULD_PROXY), t = v();
                        ...
                        (function () {
                            ...
                            function X() {
                                try {
                                    ...
                                    var b = w(a), c = [].concat(i(b.args)), d = b.isLegacySyntax, e = c.shift();
                                    switch (e) {
                                    case 'addPixelId':
                                        R = !0;
                                        Y.apply(this, c);
                                    ...
                                    case 'send':
                                        ...
                                        break;
                                    case 'on':
                                        var j = h(c), k = j[0], l = j.slice(1), m = z[k];
                                        m && m.triggerWeakly(l);
                                        break;
                                    case 'loadPlugin':
                                        W.loadPlugin(c[0]);
                            ...
                            function ja(a) {
                                ...
                                case 'releaseSegment':
                                    ...
                                    break;
                                case 'autoConfig':
                                    var l = c[0], m = c[1], n = l === !0 || l === 'true' ? 'optIn' : 'optOut';
                                    if (typeof m !== 'string') {
                                        M({
                                ...
                                case 'firstPartyCookies':
                                    var o = c[0], q = c[1], s = o === !0 || o === 'true' ? 'optIn' : 'optOut';
                                    typeof q === 'string' ? V.callMethod([
                                        s,
                                        q,
                                        'FirstPartyCookies'
                                    ]) : q === void 0 ? V.disableFirstPartyCookies = !0 : M({
                                        invalidParamName: 'pixel_id',
                                        invalidParamValue: q,
                                        method: 'set',
                                        params: e,
                                ...
                                case 'parallelfire':
                                    var A = c[0], B = c[1];
                                    V.pluginConfig.set(A, 'parallelfire', { target: B });
                                    break;
                                case 'pcmInstagramTriggerAttribution':
                                    var C = c[0];
                                    V.pluginConfig.set(C, 'pcmInstagramTriggerAttribution', { pcmInstagramTriggerAttributionURL: j.INSTAGRAM_TRIGGER_ATTRIBUTION });
                                    break;
                                case 'trackSingleOnly':
                                    var D = c[0], E = c[1], F = aa(D, ba['boolean']()), G = aa(E, ba.fbid());
                                    if (G == null) {
                                        M({
                                            invalidParamName: 'pixel_id',
                                            invalidParamValue: E,
                                    ...
                                    break;
                                default:
                                    var I = V.pluginConfig.getWithGlobalFallback(null, 'dataProcessingOptions'), J = I != null && I.dataProcessingOptions.includes('LDU'), K = c[0], L = c[1];
                                    if (typeof a !== 'string')
                            ...
                            function Z(a, b, c) {
                                for (var d = 0, e = S.length; d < e; d++) {
                                    var f = S[d];
                                    if (!(a === 'PageView' && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(U, a) && U[a].has(f.id))
                                        continue;
                                    if (f.trackSingleOnly)
                                        continue;
                                    $({
                                        customData: b,
                                        eventData: c,
                            ...
                            function $(a) {
                                var d = a.customData, e = a.eventData, f = a.eventName;
                                a = a.pixel;
                            ...
                            (R && fa || a.fbq !== a._fbq) && M({ type: 'CONFLICTING_VERSIONS' });
