...
{
    const $___mock_ad56994ef017355a = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_ad56994ef017355a);
    (function () {
        NolTracker = $___var_26f091acd089674f;
        ...
        logger = $___var_eb76d857fb0cecba;
        ...
        function $___var_26f091acd089674f(d, b) {
            try {
                ...
                this.globals = {
                    ...
                    wlCurrRetry: -1,
                    wlMaxRetry: 3,
                    domain: this.pvar && this.pvar.hasOwnProperty('server') && typeof this.pvar.server !== 'undefined' ? String(this.pvar.server).toLowerCase() : '',
                    cid: this.pvar && this.pvar.hasOwnProperty('cid') && typeof this.pvar.cid !== 'undefined' ? String(this.pvar.cid).toLowerCase() : '',
                    content: this.pvar && this.pvar.hasOwnProperty('content') && typeof this.pvar.content !== 'undefined' && String(this.pvar.content).length !== 0 ? String(this.pvar.content).toLowerCase() : '0',
                    origAuWhitelist: {
                        'au-ziffdavis': {},
                        ziffdavis: {},
                        'kataweb-it': {}
                    ...
                    si: window.location.href.replace(/\"/g, '').replace(/\'/g, '').replace(/%27/g, '').replace(/%22/g, ''),
                    init: function () {
                    ...
                    !function (e, f) {
                        e[f] = e[f] || {
                            nlsQ: function (k, l, m, j, h, g) {
                                return h = e.document, j = h.createElement('script'), j.async = 1, j.src = ('http:' === e.location.protocol ? 'http:' : 'https:') + '//cdn-gl.imrworldwide.com/conf/' + k + '.js#name=' + l + '&ns=' + f, g = h.getElementsByTagName('script')[0], g.parentNode.insertBefore(j, g), e[f][l] = e[f][l] || {
                                    g: m,
                                    ggPM: function (q, t, p, o, n) {
                                        (e[f][l].q = e[f][l].q || []).push([
                                            q,
                                            t,
                                            p,
                                            o,
                ...
                if (this.globals.domain.indexOf('secure-au') !== -1 || this.globals.domain.indexOf('secure-it') !== -1 || this.globals.domain.indexOf('secure-nz') !== -1 || this.globals.hasOwnProperty('origAuWhitelist') && Object.keys(this.globals.origAuWhitelist).length > 0 && this.globals.origAuWhitelist.hasOwnProperty(this.globals.cid)) {
        ...
        function $___var_c55d8150348b3e2f(b, a) {
        ...
        NolTracker.prototype.injectBsdk = function (b) {
            try {
                var i = 0, j = this, g = {
                    ...
                    }, c = j.globals.defaultApidFile, a = 'v60Bsdk__' + Date.now();
        ...
        NolTracker.prototype.retrieveCiFileViaCors = function (c) {
            try {
                var f, b = true, j = this, k = [
                        200,
                        302
                    ], a = 'https://bee.imrworldwide.com/v1/clients/match?client_id=' + this.globals.cid + '&url=' + encodeURI(window.location.href), i = function (e) {
                ...
                if (window.XDomainRequest) {
                    ...
                    f.onload = function () {
                        try {
                            var n = new ActiveXObject('Microsoft.XMLDOM'), m = JSON.parse(f.responseText);
                            n.async = false;
                        } catch (l) {
                            i(l);
                        }
        ...
        function $___var_eb76d857fb0cecba(a) {
        ...
        NolTracker.prototype.processDdrsSvc = function (f) {
            var b = this, a = {
                    apidFile: undefined,
                    nolparams: { nol_override: { nol_pageURL: this.globals.si && this.globals.si.length > 0 ? this.globals.si : '' } }
                };
            try {
                function d(g) {
                ...
                if (f && f.hasOwnProperty('processError')) {
                    ...
                    if ([
                            ...
                            'nomatch',
                            'notfound'
                        ].indexOf(f.status.toLowerCase()) > -1) {
                        d(f);
                        a.apidFile = true;
                        return a;
                    } else {
        ...
        NolTracker.prototype.addScript = function (d) {
            try {
                ...
                b.onerror = function (e) {
                    ...
                    if (a.globals.hasOwnProperty('wlCurrRetry') && a.globals.hasOwnProperty('wlMaxRetry') && ++a.globals.wlCurrRetry < a.globals.wlMaxRetry) {
        ...
        NolTracker.prototype.fireToUrl = function (a) {
            try {
                if (typeof a === 'undefined' || (a && (!a.hasOwnProperty('url') || a.url.length === 0) || !a.hasOwnProperty('retryDelay') || !a.hasOwnProperty('currRetry') || !a.hasOwnProperty('maxRetry'))) {
                    return;
                }
                var b = {
                    requestUrl: function () {
                        try {
                            var d = this;
                            return ++a.currRetry > a.maxRetry ? d.logErr('maxRetry reached') : d.sendUrlRequest(a.url);
                        } catch (e) {
        ...
        NolTracker.prototype.whitelistAssigned = function (a) {
            try {
                if (window.V60 && window.V60.hasOwnProperty('ciWhitelist') && window.V60.ciWhitelist.hasOwnProperty('nol_clients') && Object.keys(window.V60.ciWhitelist.nol_clients).length > 0) {
                    var a = this;
                    var f = a.pvar && a.pvar.hasOwnProperty('cid') && typeof a.pvar.cid !== 'undefined' ? String(a.pvar.cid).toLowerCase() : '';
                    if (window.V60.ciWhitelist.nol_clients.hasOwnProperty(f)) {
                        var d = window.V60.ciWhitelist.nol_clients[f], c = window.V60.ciWhitelist && window.V60.ciWhitelist.nol_clients ? window.V60.ciWhitelist.nol_clients : {};
        ...
        NolTracker.prototype.record = function () {
            const $___old_08200f96cef48357 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
            try {
                if ($___old_08200f96cef48357)
                    ({}.constructor.defineProperty(window, 'localStorage', $___mock_ad56994ef017355a.localStorage));
                return function () {
                    this.postChk = false;
                    this.page_url = '' + window.location;
                    this.referrer = '' + document.referrer;
                    try {
                        if (this.feat && this.feat.check_fraud && top.location.href.indexOf(document.domain) === -1) {
                ...
                if ($___old_08200f96cef48357)
                    ({}.constructor.defineProperty(window, 'localStorage', $___old_08200f96cef48357));
            }
        };
        NolTracker.prototype.regListen = function () {
            var a = this;
            return function (b) {
                const $___old_81614c49ba14725f = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_81614c49ba14725f)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_ad56994ef017355a.localStorage));
                    return function () {
                        if (b && b.origin && b.origin.indexOf('imrworldwide.com') !== -1 && (typeof b.data === 'string' || b.data instanceof String) && b.data.indexOf('{') === -1 && b.data !== '') {
                            if (typeof localStorage.Y29va2llX293X25hbWUK === 'undefined' || !localStorage.Y29va2llX293X25hbWUK || b.data.search(/;JA$/) === -1) {
                                a.cookie_overwrite = b.data.replace(/;JA$/, '');
                            } else {
                                if (typeof localStorage.Y29va2llX293X25hbWUK === 'string' || localStorage.Y29va2llX293X25hbWUK instanceof String) {
                    ...
                    if ($___old_81614c49ba14725f)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_81614c49ba14725f));
                }
            };
        };
        ...
        NolTracker.prototype.prefix = function () {
            ...
            if (c === 'm') {
                if (typeof _rsCI == 'string') {
                    a.push('&cg=', encodeURIComponent(b && b.content ? b.content : (this.pvar ? this.pvar.content : null) || (this.pvar.content == '' ? '' : '0')));
                } else {
                    a.push('&cg=', encodeURIComponent(b && b.content ? b.content : (this.pvar ? this.pvar.content : null) || '0'));
                }
            }
            if (this.scriptName) {
        ...
        NolTracker.prototype.post = function () {
            ...
            if (this.feat && this.feat.landing_page && this.referrer && document.location.search.search(/[&?]nol\./) !== -1) {
                var b = [];
                var m = document.location.search.substring(document.location.search.lastIndexOf('?') + 1).split('&');
                for (var g in m) {
            ...
            var c = null, p = null, h = null, e = null;
        ...
        NolTracker.prototype.postEvent = function () {
            ...
            if (c && c.event_type) {
                ...
                a.push('&cc=0', '&si=', this.pvar ? this.pvar.cid : '', '-ctgw-', encodeURIComponent(b), '&rp=', encodeURIComponent(window.location));
            }
            this.postData(a.join(''));
            return this;
        };
        ...
        NolTracker.prototype.sendIt = function (c, d, e, a) {
            var b = [
                ...
                '-ctpo-',
                encodeURIComponent(decodeURIComponent(c).replace(/^\s+|\s+$/g, '').replace(/\s+/g, ' ')),
                '&rp=',
                ...
                '&cv=',
                encodeURIComponent(decodeURIComponent(a).replace(/^\s+|\s+$/g, '').replace(/\s+/g, ' '))
            ];
        ...
        NolTracker.prototype.invite = function () {
            ...
            var e = null, a = null, c = null, h = null;
        ...
        NolTracker.prototype.getSchemeHost = function () {
            var a = [
                ...
                this.pvar && this.pvar.server && this.pvar.server.indexOf('imrworldwide.com') === -1 ? '.imrworldwide.com' : '',
                '/'
            ];
            return a.join('');
        };
