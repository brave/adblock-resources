var OneTrustStub;
{
    const $___mock_9e75d43b9729b396 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_9e75d43b9729b396);
    (function () {
        var $___var_40fbb7c2377707e9 = function (e) {
            'use strict';
            var t, o, n, i, a, r, s, l, c, p, u, d, m, h, f, g, A, b, y, v, C, I, w, S, T, L, R, B, D, P, _, E, G, U, O, k, F, V, N, x, j, H, M, K, z, q, J, W, Y, Q, X, Z, $, ee = new function () {
                    this.optanonCookieName = 'OptanonConsent', this.optanonHtmlGroupData = [], this.optanonHostData = [], this.genVendorsData = [], this.IABCookieValue = '', this.oneTrustIABCookieName = 'eupubconsent', this.oneTrustIsIABCrossConsentEnableParam = 'isIABGlobal', this.isStubReady = !0, this.geolocationCookiesParam = 'geolocation', this.EUCOUNTRIES = [
                        'BE',
                        'BG',
                        'CZ',
                        'DK',
            ...
            function ie() {
                ...
                this.implementThePolyfill = function () {
                    var i = e, a = Element.prototype.setAttribute;
                    return Element.prototype.setAttribute = function (e, t) {
                        if ('style' !== e.toLowerCase() && a.apply(this, [
                                e,
                                t
                            ]), 'style' === e.toLowerCase()) {
            ...
            function ae(e, t, o) {
                ...
                var a = n(e.getAttribute('style')), r = n(t), i = '';
                i = o && a ? function () {
            ...
            var re = (se.prototype.initConsentSDK = function () {
                this.initCustomEventPolyfill(), this.ensureHtmlGroupDataInitialised(), this.updateGtmMacros(), this.getParam(), this.fetchBannerSDKDependency(), this.captureNonce();
            }, se.prototype.captureNonce = function () {
                this.nonce = ee.stubScriptElement.getAttribute('nonce') || null;
                ...
                if (t && t.CookieV2CSP && this.nonce && (this.setAttributePolyfillIsActive = !0, new ne().implementThePolyfill()), !e.RuleSet[0].Type)
                    return this.iabTypeAdded = !1, window.__cmp = this.executeCmpApi, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(e);
                var o = window;
                ...
                var t = this, o = e.TenantFeatures, n = this.getGeolocationURL(e);
                ...
                const $___old_857c3c430fb341c4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_02a98fe9e9b0eea6 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_857c3c430fb341c4)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_9e75d43b9729b396.XMLHttpRequest));
                    if ($___old_02a98fe9e9b0eea6)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_9e75d43b9729b396.XMLHttpRequest));
                    return function () {
                    ...
                    if ($___old_857c3c430fb341c4)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_857c3c430fb341c4));
                    if ($___old_02a98fe9e9b0eea6)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_02a98fe9e9b0eea6));
                }
            }, se.prototype.otFetchOfflineFile = function (e, t) {
                var o = (e = e.replace('.json', '.js')).split('/'), n = o[o.length - 1].split('.js')[0];
                ...
                var t, o, n, i = ee.userLocation, a = e.RuleSet.filter(function (e) {
                        return !0 === e.Default;
                    });
                ...
                if (r) {
                    for (n = {}, i = r.split('&'), o = 0; o < i.length; o += 1)
                        a = i[o].split('='), n[decodeURIComponent(a[0])] = decodeURIComponent(a[1]).replace(/\+/g, ' ');
                ...
                for (e = 0; e < ee.optanonHtmlGroupData.length; e++)
                    this.endsWith(ee.optanonHtmlGroupData[e], ':1') && t.push(ee.optanonHtmlGroupData[e].replace(':1', ''));
                for (e = 0; e < ee.optanonHostData.length; e++)
                    this.endsWith(ee.optanonHostData[e], ':1') && t.push(ee.optanonHostData[e].replace(':1', ''));
                for (e = 0; e < ee.genVendorsData.length; e++)
                    this.endsWith(ee.genVendorsData[e], ':1') && t.push(ee.genVendorsData[e].replace(':1', ''));
                var o = ',' + this.serialiseArrayToString(t) + ',';
                window.OnetrustActiveGroups = o, window.OptanonActiveGroups = o, void 0 !== window.dataLayer ? window.dataLayer.constructor === Array && (window.dataLayer.push({ OnetrustActiveGroups: o }), window.dataLayer.push({ OptanonActiveGroups: o })) : window.dataLayer = [
                    {
                ...
                var n, i = new CustomEvent('consent.onetrust', { detail: t });
                ...
                var e = ee.stubScriptElement.getAttribute('src'), t = -1 < e.indexOf('/consent');
                e && (ee.isMigratedURL ? ee.storageBaseURL = e.split('/consent/' + ee.migratedCCTID)[0] : ee.storageBaseURL = t ? e.split('/consent')[0] : e.split('/scripttemplates/' + ee.stubFileName)[0]), this.isPreview && -1 === this.domainId.indexOf('test') ? this.domainId = this.domainId + '-test' : this.isPreview = !1, ee.bannerBaseDataURL = ee.storageBaseURL && ee.storageBaseURL + '/consent/' + this.domainId, ee.bannerDataParentURL = ee.bannerBaseDataURL + '/' + this.domainId + '.json';
                ...
                var o = this.readCookieParam(oe, 'expiry'), n = this.readCookieParam(oe, te);
            ...
            function se() {
                var c = this;
                this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = '', this.isReset = !1, this.isPreview = !1, this.geoFromUrl = '', this.nonce = '', this.setAttributePolyfillIsActive = !1, this.addBannerSDKScript = function (e) {
                    var t = null;
                    c.iabTypeAdded && ('IAB' !== (t = c.getRegionSet(e)).Type && 'IAB2' !== t.Type || (c.iabType = t.Type, c.intializeIabStub()), 'IAB2' !== t.Type && c.removeTcf());
                    var o = ee.stubScriptElement.cloneNode(!0), n = '';
                    ...
                    var e = window, t = 'IAB' === c.iabType ? '__cmpLocator' : '__tcfapiLocator';
                    ...
                    var o = window, n = o.document.createElement('iframe');
                    ...
                    var i = 'string' == typeof n.data, e = {};
                    try {
                        e = i ? JSON.parse(n.data) : n.data;
                    } catch (e) {
                    }
                    if (e.__cmpCall && 'IAB' === c.iabType) {
                        var a = e.__cmpCall.callId, r = e.__cmpCall.command, t = e.__cmpCall.parameter;
                    ...
                    if (e.__tcfapiCall && 'IAB2' === c.iabType) {
                        var s = e.__tcfapiCall.callId, l = e.__tcfapiCall.command, o = (t = e.__tcfapiCall.parameter, e.__tcfapiCall.version);
        ...
        OneTrustStub = $___var_40fbb7c2377707e9;
    }())
}