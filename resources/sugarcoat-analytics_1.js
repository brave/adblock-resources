{
    const $___mock_776835aef0316d9e = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        ...
        (function () {
            ...
            var bd = function (a) {
                    ...
                    const $___old_95fcfae61cead05a = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_abcc5ea0b06be5b4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_95fcfae61cead05a)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_776835aef0316d9e.XMLHttpRequest));
                        if ($___old_abcc5ea0b06be5b4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_776835aef0316d9e.XMLHttpRequest));
                        return function () {
                        ...
                        if ($___old_95fcfae61cead05a)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_95fcfae61cead05a));
                        if ($___old_abcc5ea0b06be5b4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_abcc5ea0b06be5b4));
                    }
                }, Ea = function (a, b, c) {
                    if (1 > b.length)
                        ge('xhr', 'ver', '0'), c();
