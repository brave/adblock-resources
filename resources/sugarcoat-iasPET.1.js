{
    const $___mock_6139ab028d0fe7a0 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        !function (e) {
            ...
            function (e, t, n) {
                ...
                var U = function e() {
                    const $___old_04761b8df4c3b217 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_04761b8df4c3b217)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_6139ab028d0fe7a0.XMLHttpRequest));
                        return function () {
                            if (function (e, t) {
                                    if (!(e instanceof t))
                                        throw new TypeError('Cannot call a class as a function');
                        ...
                        if ($___old_04761b8df4c3b217)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_04761b8df4c3b217));
                    }
                };
