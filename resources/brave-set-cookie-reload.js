...
(function () {
    ...
    const isCookieSetWithValue = (cookieString, name, value) => {
    ...
    if (isCookieSetWithValue(document.cookie, cookieName, cookieValue)) {
      return
    }
    ...
    if (isCookieSetWithValue(document.cookie, cookieName, limitedCookieValue)) {
