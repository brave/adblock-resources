var _satellite;
{
    const $___mock_1aaec3d61247be0f = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    })($___mock_1aaec3d61247be0f);
    const $___mock_ad28430541c1d11b = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
    ...
    (function () {
        window._satellite = window._satellite || {}, window._satellite.container = {
            ...
            extensions: {
                'adobe-analytics': {
                    ...
                    modules: {
                        'adobe-analytics/src/lib/actions/sendBeacon.js': {
                            ...
                            script: function (e, t, n, i) {
                                'use strict';
                                var r = n('../sharedModules/getTracker'), o = function (e) {
                                        ...
                                        if ('page' === t.type)
                                            ...
                                            var r = {
                                                ...
                                                linkName: t.linkName || a(n)
                                            };
                                            i.logger.info('Firing link track beacon using the values: ' + JSON.stringify(r) + '.'), e.tl(o(n) ? n : 'true', r.linkType, r.linkName);
                                        }
                                    };
                        ...
                        'adobe-analytics/src/lib/sharedModules/getTracker.js': {
                            script: function (e, t, n, r) {
                                'use strict';
                                var i, o = n('@adobe/reactor-cookie'), a = n('@adobe/reactor-promise'), s = n('@adobe/reactor-window'), c = n('../helpers/settingsHelper'), u = n('../helpers/augmenters'), l = n('../helpers/applyTrackerVariables'), d = n('../helpers/loadLibrary'), f = n('../helpers/generateVersion')(r.buildInfo.turbineBuildDate), p = 'beforeSettings', g = r.getSharedModule('adobe-mcid', 'mcid-instance'), m = function (e) {
                                    ...
                                    }, C = (i = r.getExtensionSettings(), m(i.trackingCookieName) ? d(i).then(h).then(v).then(b).then(y.bind(null, i.trackerProperties, i.customSetup || {})).then(_.bind(null, i)) : a.reject('EU compliance was not acknowledged by the user.'));
                                e.exports = function () {
                                    return C;
                                };
                            },
                        ...
                        'adobe-analytics/src/lib/helpers/settingsHelper.js': {
                            script: function (e, t, n, r) {
                                'use strict';
                                var i = n('@adobe/reactor-window'), o = {
                                        LIB_TYPES: {
                                            MANAGED: 'managed',
                        ...
                        'adobe-analytics/src/lib/helpers/applyTrackerVariables.js': {
                            script: function (e, t, n, a) {
                                'use strict';
                                var i = n('@adobe/reactor-query-string'), o = n('@adobe/reactor-window'), s = /eVar([0-9]+)/, c = /prop([0-9]+)/, u = new RegExp('^(eVar[0-9]+)|(prop[0-9]+)|(hier[0-9]+)|campaign|purchaseID|channel|server|state|zip|pageType$'), l = function (e, t, n) {
                                ...
                                e.exports = function (t, r) {
                                    ...
                                    n && (i.linkTrackVars = n);
                                    var o = f(t, r.events || []);
                                    o && (i.linkTrackEvents = o), a.logger.info('Applying the following properties on tracker: "' + JSON.stringify(i) + '".'), Object.keys(i).forEach(function (e) {
                                        t[e] = i[e];
                                    });
                                };
                            }
                        ...
                        'adobe-analytics/src/lib/helpers/loadLibrary.js': {
                            script: function (e, t, n, r) {
                                'use strict';
                                var i = n('@adobe/reactor-load-script'), o = n('@adobe/reactor-window'), a = n('@adobe/reactor-promise'), s = n('./settingsHelper'), c = n('./pollHelper'), u = function (e, t) {
                                        if (!o.s_gi)
                                        ...
                                        return a.all(l(e).map(function (e) {
                                ...
                                e.exports = function (e) {
                                    ...
                                    case s.LIB_TYPES.PREINSTALLED:
                                        return t.then(c.poll.bind(null, o, e.libraryCode.trackerVariableName)).then(f.bind(null, e));
                                    case s.LIB_TYPES.CUSTOM:
                                    case s.LIB_TYPES.REMOTE:
                        ...
                        'adobe-analytics/src/lib/helpers/pollHelper.js': {
                            script: function (e, t, n, r) {
                                'use strict';
                                var a = n('@adobe/reactor-promise'), s = 40, c = 250, u = function (e, t, n) {
                                        ...
                                        return new a(function (e, t) {
                                            ...
                                            var n = 1, r = setInterval(function () {
                                                    i[o] && (u(e, o, i[o]), clearInterval(r)), s <= n && (clearInterval(r), t(new Error('Bailing out. Cannot find the variable name: "' + o + '"].'))), n++;
                                                }, c);
                                        });
                                    };
                                e.exports = {
                    ...
                    settings: {
                        orgId: '0AAF22CE52827A080A490D4D@AdobeOrg',
                        libraryCode: {
                            type: 'managed',
                            accounts: {
                                staging: ['scotiabankdev2'],
                                production: ['scotiabanktangerine'],
                                development: ['scotiabankdev2']
                            },
                            useActivityMap: !0,
                        ...
                        trackerProperties: {
                            ...
                            pageName: '%pageTitle%',
                            currencyCode: 'USD',
                            trackingServer: 'omniture.scotiabank.com',
                            trackInlineStats: !0,
                            trackDownloadLinks: !0,
                            trackExternalLinks: !0,
                            trackingServerSecure: 'somniture.scotiabank.com',
                ...
                core: {
                    ...
                    modules: {
                        ...
                        'core/src/lib/events/helpers/pageLifecycleEvents.js': {
                            script: function (e, t, n) {
                                'use strict';
                                var r = n('@adobe/reactor-window'), i = n('@adobe/reactor-document'), o = -1 !== r.navigator.appVersion.indexOf('MSIE 10'), a = 'WINDOW_LOADED', s = 'DOM_READY', c = 'PAGE_BOTTOM', u = [
                                        c,
                                        s,
                                        a
                                    ], l = function (e, t) {
                                ...
                                var f = function (e, t) {
                                        ...
                                        return 'complete' === i.readyState ? a : 'interactive' === i.readyState ? o ? null : s : void 0;
                                    }, g = function (e) {
                                        return u.indexOf(e);
                                    }, m = function (t, e) {
                                ...
                                r._satellite = r._satellite || {}, r._satellite.pageBottom = f.bind(null, c), i.addEventListener('DOMContentLoaded', f.bind(null, s), !0), r.addEventListener('load', f.bind(null, a), !0), r.setTimeout(function () {
                                    var e = p();
                                    e && f(e);
                                }, 0), e.exports = {
                ...
                'adobe-mcid': {
                        ...
                        'adobe-mcid/src/lib/sharedModules/mcidInstance.js': {
                            script: function (e, t, n, g) {
                                ...
                                _satellite.getVisitorId = function () {
                                    return s;
                                }, a(r.location.pathname) ? g.logger.warn('MCID library not loaded. One of the path exclusions matches the current path.') : s = o(i), e.exports = s;
                            },
                            name: 'mcid-instance',
                            shared: !0
                        },
                        'adobe-mcid/src/lib/codeLibrary/VisitorAPI.js': {
                            script: function (e) {
                                e.exports = (function () {
                                    ...
                                    function L(e, t) {
                                        var i = (0 < arguments.length && void 0 !== e ? arguments[0] : {}).cookieName, o = (1 < arguments.length && void 0 !== t ? arguments[1] : {}).cookies;
                                        if (!i || !o)
                                            return {
                                                get: Oe,
                                                set: Oe,
                                        ...
                                        var a = {
                                            ...
                                            set: function (e, t) {
                                                t = t || {};
                                                var n = a.get(), r = Object.assign(n, e);
                                    ...
                                    function l(e, t) {
                                        ...
                                        function r() {
                                            P(T), w(B.COMPLETE), I(C.status, C.permissions), u && _.set(C.permissions, {
                                                optInCookieDomain: l,
                                        ...
                                        function i(n) {
                                            return function (e, t) {
                                                ...
                                                return w(B.CHANGED), Object.assign(T, _e(ve(e), n)), t || r(), C;
                                            };
                                        }
                                        var o = 0 < arguments.length && void 0 !== e ? arguments[0] : {}, a = o.doesOptInApply, s = o.previousPermissions, c = o.preOptInApprovals, u = o.isOptInStorageEnabled, l = o.optInCookieDomain, d = o.optInStorageExpiry, f = o.isIabContext, p = (1 < arguments.length && void 0 !== t ? arguments[1] : {}).cookies, g = ke(s);
                                        Me(g, 'Invalid `previousPermissions`!'), Me(c, 'Invalid `preOptInApprovals`!');
                                        var m, h, v, b, y, _ = L({ cookieName: 'adobeujs-optin' }, { cookies: p }), C = this, I = H(C), S = ue(), A = Se(g), D = Se(c), E = u ? _.get() : {}, O = {}, k = (y = E, Ae(A) || y && Ae(y) ? B.COMPLETE : B.PENDING), M = (m = D, h = A, v = E, b = _e(ce, !a), a ? Object.assign({}, b, m, h, v) : b), T = Ce(M), w = function (e) {
                                                return k = e;
                                            }, P = function (e) {
                                                return M = e;
                                            };
                                        C.deny = i(!1), C.approve = i(!0), C.denyAll = C.deny.bind(C, ce), C.approveAll = C.approve.bind(C, ce), C.isApproved = function (e) {
                                            ...
                                            var n = 1 < arguments.length && void 0 !== t && arguments[1], r = n ? C.on(B.COMPLETE, e) : Oe;
                                            return !a || a && C.isComplete || c ? e(C.permissions) : n || S.add(Le, function () {
                                                return e(C.permissions);
                                            }), r;
                                        }, C.complete = function () {
                                            C.status === B.CHANGED && r();
                                        }, C.registerPlugin = function (e) {
                                            if (!e || !e.name || 'function' != typeof e.onRegister)
                                                throw new Error(xe);
                                            O[e.name] || (O[e.name] = e).onRegister.call(e, C);
                                        }, C.execute = Pe(O), C.memoizeContent = function (e) {
                                            Ee(e) && _.set(e, {
                                                optInCookieDomain: l,
                                                optInStorageExpiry: d
                                            });
                                            ...
                                            isPending: {
                                                get: function () {
                                                    return C.status === B.PENDING;
                                                }
                                            },
                                            isComplete: {
                                                get: function () {
                                                    return C.status === B.COMPLETE;
                                                }
                                            },
                                            __plugins: {
                                                get: function () {
                                    ...
                                    function g(t, e, n) {
                                        var r = 2 < arguments.length && void 0 !== n ? arguments[2] : [], i = !0 === t.vendor.consents[e], o = r.every(function (e) {
                                    ...
                                    function m() {
                                        ...
                                        var o, a = ue(), s = { transparencyAndConsentData: null }, c = function (e, t) {
                                        ...
                                        n.fetchConsentData = function (e) {
                                            ...
                                            o = r;
                                            var t = Object.keys(oe), e = function (e, n) {
                                        ...
                                        var u = function (e) {
                                                ...
                                                a.add('FETCH_CONSENT_DATA', t), r(function (e, t) {
                                                    if (t) {
                                                        var n = Ce(e), r = o.getMemoizedContent('iabConsentHash'), i = ge(n.tcString).toString(32);
                                                        n.consentString = e.tcString, n.hasConsentChangedSinceLastCmpPull = r !== i, c('transparencyAndConsentData', n), o.memoizeContent({ iabConsentHash: i });
                                                    }
                                    ...
                                    var h, v, b, y, W = {
                                        ...
                                        }, _ = W.STATE_KEYS_MAP, C = function (o) {
                                            function r() {
                                            }
                                            function i(n, r) {
                                                var i = this;
                                        ...
                                        }, I = W.MESSAGES, S = W.ASYNC_API_MAP, A = W.SYNC_API_MAP, D = function () {
                                            function i() {
                                            }
                                            function o(e, t) {
                                                var n = this;
                                            ...
                                            function e(r) {
                                                this[S[r]] = function (e) {
                                                    e = e || i;
                                                    var t = this.findField(r, e), n = o.call(this, r, e);
                                                    return void 0 !== t ? t : n();
                                                };
                                            }
                                            function t(e) {
                                            ...
                                            Object.keys(S).forEach(e, this), Object.keys(A).forEach(t, this);
                                        }, E = W.ASYNC_API_MAP, O = function () {
                                            ...
                                            t.getIeVersion = function () {
                                                ...
                                                return null !== e && 'object' === Y(e) && !1 === Array.isArray(e);
                                        ...
                                        }(y = { exports: {} }, y.exports), y.exports), k = (J.isObjectEmpty, J.isValueEmpty, J.getIeVersion, J.encodeAndBuildRequest, J.isObject, J.defineGlobalNamespace, J.pluck, J.parseOptOut, J.normalizeBoolean, t), M = W.MESSAGES, T = {
                                            0: 'prefix',
                                            1: 'orgID',
                                            2: 'state'
                                        }, X = function (o, a) {
                                            this.parse = function (e) {
                                                ...
                                                if (!t || Object.keys(t).length < 2)
                                                    return !0;
                                                var n = o !== t.orgID, r = !a || e.origin !== a, i = -1 === Object.keys(M).indexOf(t.prefix);
                                                return n || r || i;
                                        ...
                                        }, w = W.MESSAGES, P = function (e, t, n, r) {
                                            function i(e) {
                                                Object.assign(p, e);
                                            }
                                            function o(e) {
                                            ...
                                            function c() {
                                                i(new C(n._generateID)), p.getMarketingCloudVisitorID(), p.callbackRegistry.executeAll(p.state, !0), q.removeEventListener('message', u);
                                            }
                                            function u(e) {
                                                if (!h.isInvalid(e)) {
                                                    var t = h.parse(e);
                                                    m = !1, q.clearTimeout(p._handshakeTimeout), q.removeEventListener('message', u), i(new D(p)), q.addEventListener('message', a), p.setStateAndPublish(t.state), p.callbackRegistry.hasCallbacks() && s(w.GETSTATE);
                                                }
                                            }
                                            function l() {
                                                g && postMessage ? (q.addEventListener('message', u), s(w.HANDSHAKE), p._handshakeTimeout = setTimeout(c, 250)) : c();
                                            }
                                            function d() {
                                                q.s_c_in || (q.s_c_il = [], q.s_c_in = 0), p._c = 'Visitor', p._il = q.s_c_il, p._in = q.s_c_in, p._il[p._in] = p, q.s_c_in++;
                                            }
                                            function f() {
                                                function e(e) {
                                            ...
                                            var m = !(p._instanceType = 'child'), h = new X(e, g);
                                            p.callbackRegistry = k(), p.init = function () {
                                                d(), f(), i(new O(p)), l();
                                            }, p.findField = function (e, t) {
                                                if (void 0 !== p.state[e])
                                                    return t(p.state[e]), p.state[e];
                                            }, p.messageParent = s, p.setStateAndPublish = o;
                                        }, x = W.MESSAGES, j = W.ALL_APIS, R = W.ASYNC_API_MAP, N = W.FIELDGROUP_TO_FIELD, z = function (i, r) {
                                            function o() {
                                                var r = {};
                                            ...
                                            function u(t) {
                                                function e(e) {
                                                    n.call(i, e), r.send(t, x.PARENTSTATE, { CUSTOMERIDS: i.getCustomerIDs() });
                                                }
                                                var n = i.setCustomerIDs;
                                                i.setCustomerIDs = e;
                                            }
                                            return function (e) {
                                                r.isInvalid(e) || (r.parse(e).prefix === x.HANDSHAKE ? s : c)(e.source);
                                            };
                                        }, K = function (r, n) {
                                            function i(t) {
                                                return function (e) {
                                            ...
                                            var o = {}, a = 0, s = Object.keys(r).length;
                                            ...
                                            set: function (e, t, n) {
                                                var r = f(n, 'cookieLifetime'), i = f(n, 'expires'), o = f(n, 'domain'), a = f(n, 'secure'), s = f(n, 'sameSite'), c = a ? 'Secure' : '', u = s ? 'SameSite=' + s + ';' : '';
                                                if (i && 'SESSION' !== r && 'NONE' !== r) {
                                                    var l = '' !== t ? parseInt(r || 0, 10) : -60;
                                                    if (l)
                                                        (i = new Date()).setTime(i.getTime() + 1000 * l);
                                                    else if (1 === i) {
                                                    ...
                                                    i = 0;
                                                return e && 'NONE' !== r ? (document.cookie = encodeURIComponent(e) + '=' + encodeURIComponent(t) + '; path=/;' + (i ? ' expires=' + i.toGMTString() + ';' : '') + (o ? ' domain=' + o + ';' : '') + u + c, this.get(e) === t) : 0;
                                            },
                                            remove: function (e, t) {
                                                var n = f(t, 'domain');
                                                n = n ? ' domain=' + n + ';' : '';
                                                var r = f(t, 'secure'), i = f(t, 'sameSite'), o = r ? 'Secure' : '', a = i ? 'SameSite=' + i + ';' : '';
                                                document.cookie = encodeURIComponent(e) + '=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;' + n + a + o;
                                            }
                                        }, Q = function (e, t) {
                                            !e && q.location && (e = q.location.hostname);
                                            var n, r = e.split('.'), i = t || {};
                                            for (n = r.length - 2; 0 <= n; n--)
                                                if (i.domain = r.slice(n).join('.'), $.set('test', 'cookie', i))
                                                ...
                                                try {
                                                    F && (t && (e = function (e) {
                                                        if ('string' == typeof n && e.origin !== n || '[object Function]' === Object.prototype.toString.call(n) && !1 === n(e.origin))
                                                            return !1;
                                                        t(e);
                                                    }), q.addEventListener ? q[t ? 'addEventListener' : 'removeEventListener']('message', e) : q[t ? 'attachEvent' : 'detachEvent']('onmessage', e));
                                                } catch (t) {
                                                }
                                            }
                                        }, te = function (e) {
                                            var t, n, r = '0123456789', i = '', o = '', a = 8, s = 10, c = 10;
                                            if (1 == e) {
                                                for (r += 'ABCDEF', t = 0; t < 16; t++)
                                                    n = Math.floor(Math.random() * a), i += r.substring(n, n + 1), n = Math.floor(Math.random() * a), o += r.substring(n, n + 1), a = 16;
                                                return i + '-' + o;
                                            }
                                            for (t = 0; t < 19; t++)
                                                n = Math.floor(Math.random() * s), i += r.substring(n, n + 1), 0 === t && 9 == n ? s = 3 : (1 == t || 2 == t) && 10 != s && n < 2 ? s = 10 : 2 < t && (s = 10), n = Math.floor(Math.random() * c), o += r.substring(n, n + 1), 0 === t && 9 == n ? c = 3 : (1 == t || 2 == t) && 10 != c && n < 2 ? c = 10 : 2 < t && (c = 10);
                                            return i + o;
                                        }, ne = function (r) {
                                            const $___old_1eba50c29b5e1ab8 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_305b080711a4cd3f = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                            try {
                                                if ($___old_1eba50c29b5e1ab8)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_1aaec3d61247be0f.XMLHttpRequest));
                                                if ($___old_305b080711a4cd3f)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_1aaec3d61247be0f.XMLHttpRequest));
                                                return function () {
                                                    return {
                                                        corsMetadata: (e = 'none', t = !0, 'undefined' != typeof XMLHttpRequest && XMLHttpRequest === Object(XMLHttpRequest) && ('withCredentials' in new XMLHttpRequest() ? e = 'XMLHttpRequest' : 'undefined' != typeof XDomainRequest && XDomainRequest === Object(XDomainRequest) && (t = !1), 0 < Object.prototype.toString.call(q.HTMLElement).indexOf('Constructor') && (t = !1)), {
                                                            corsType: e,
                                                            corsCookiesEnabled: t
                                                        }),
                                                        getCORSInstance: function () {
                                                            const $___old_ff78aa1a9afe41b7 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_7ba51b7184352033 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                                                            try {
                                                                if ($___old_ff78aa1a9afe41b7)
                                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_1aaec3d61247be0f.XMLHttpRequest));
                                                                if ($___old_7ba51b7184352033)
                                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_1aaec3d61247be0f.XMLHttpRequest));
                                                                return function () {
                                                                    return 'none' === this.corsMetadata.corsType ? null : new q[this.corsMetadata.corsType]();
                                                                }.apply(this, arguments);
                                                            } finally {
                                                                if ($___old_ff78aa1a9afe41b7)
                                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_ff78aa1a9afe41b7));
                                                                if ($___old_7ba51b7184352033)
                                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7ba51b7184352033));
                                                            }
                                                        },
                                                        fireCORS: function (o, e) {
                                                            function t(e) {
                                                                ...
                                                                try {
                                                                    if ((t = JSON.parse(e)) !== Object(t))
                                                                        return void a.handleCORSError(o, null, 'Response is not JSON');
                                                                } catch (e) {
                                                                    return void a.handleCORSError(o, e, 'Error parsing response as JSON');
                                                                }
                                                                try {
                                                            ...
                                                            try {
                                                                ...
                                                                n.open('get', o.corsUrl + '&ts=' + new Date().getTime(), !0), 'XMLHttpRequest' === this.corsMetadata.corsType && (n.withCredentials = !0, n.timeout = r.loadTimeout, n.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'), n.onreadystatechange = function () {
                                                                ...
                                                                }, n.send(), r._log.requests.push(o.corsUrl);
                                                            } catch (r) {
                                                ...
                                                if ($___old_1eba50c29b5e1ab8)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_1eba50c29b5e1ab8));
                                                if ($___old_305b080711a4cd3f)
                                                    ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_305b080711a4cd3f));
                                            }
                                        }, re = {
                                            ...
                                            return {
                                                    ...
                                                    if (e === Object(e) && e.ibs)
                                                        if (n = JSON.stringify(e.ibs || []), this.jsonForComparison.length) {
                                                            ...
                                                            for (i = 0, o = this.jsonForComparison.length; i < o; i++)
                                                                if (a = this.jsonForComparison[i], n === JSON.stringify(a.ibs || [])) {
                                                                    s = !0;
                                                                    break;
                                                                }
                                                ...
                                                process: function (e) {
                                                    var t, n, r, i, o, a = encodeURIComponent, s = !1;
                                                    if ((t = e.ibs) && t instanceof Array && (n = t.length))
                                                        for (s = !0, r = 0; r < n; r++)
                                                            i = t[r], o = [
                                                                a('ibs'),
                                                                a(i.id || ''),
                                                                a(i.tag || ''),
                                                                J.encodeAndBuildRequest(i.url || [], ','),
                                                                a(i.ttl || ''),
                                                                '',
                                                                '',
                                                                i.fireURLSync ? 'true' : 'false'
                                                            ], i.syncOnPage || (this.canSetThirdPartyCookies ? this.addMessage(o.join('|')) : i.fireURLSync && this.checkFirstPartyCookie(i, o.join('|')));
                                                    s && this.jsonProcessed.push(e);
                                                },
                                                checkFirstPartyCookie: function (e, t, n) {
                                                    var r = 'syncOnPage' === n, i = r ? 'MCSYNCSOP' : 'MCSYNCS';
                                                    g._readVisitor();
                                                    var o, a, s = g._getField(i), c = !1, u = !1, l = Math.ceil(new Date().getTime() / re.MILLIS_PER_DAY);
                                                    s ? (o = s.split('*'), c = (a = this.pruneSyncData(o, e.id, l)).dataPresent, u = a.dataValid, c && u || this.fireSync(r, e, t, o, i, l)) : (o = [], this.fireSync(r, e, t, o, i, l));
                                                },
                                                pruneSyncData: function (e, t, n) {
                                                    var r, i, o, a = !1, s = !1;
                                                    for (i = 0; i < e.length; i++)
                                                        r = e[i], o = parseInt(r.split('-')[1], 10), r.match('^' + t + '-') ? (a = !0, n < o ? s = !0 : (e.splice(i, 1), i--)) : o <= n && (e.splice(i, 1), i--);
                                                    return {
                                                        dataPresent: a,
                                                        dataValid: s
                                                    };
                                                ...
                                                fireSync: function (e, t, n, r, l, i) {
                                                    ...
                                                    if (e) {
                                                        if ('img' === t.tag) {
                                                            var o, a, s, c, u = t.url, f = g.loadSSL ? 'https:' : 'http:';
                                                ...
                                                addMessage: function (e) {
                                                    ...
                                                    this.messages.push((re.POST_MESSAGE_ENABLED ? '' : t) + e);
                                                },
                                                ...
                                                sendMessages: function () {
                                                    ...
                                                    this.regionChanged && (n = r('---destpub-clear-dextp---'), this.regionChanged = !1), this.messages.length ? re.POST_MESSAGE_ENABLED ? (e = n + r('---destpub-combined---') + this.messages.join('%01'), this.postMessage(e), this.messages = [], this.sendingMessages = !1) : (e = this.messages.shift(), this.postMessage(n + e), setTimeout(function () {
                                                        t.sendMessages();
                                                ...
                                                canMakeSyncIDCall: function (e, t) {
                                                    return g._forceSyncIDCall || !e || t - e > re.DAYS_BETWEEN_SYNC_ID_CALLS;
                                                },
                                            ...
                                            normalizeConfig: function (e, t) {
                                                return V[e] && 'boolean' === V[e].type ? 'function' != typeof t ? t : t() : t;
                                            }
                                        }, H = function (e) {
                                            var i = {};
                                        ...
                                        }, oe = (e(h = {}, G.AAM, 565), e(h, G.ECID, 565), h), ae = (e(v = {}, G.AAM, [
                                            1,
                                            10
                                        ]), e(v, G.ECID, [
                                            1,
                                            ...
                                            'videoaa',
                                            'iabConsentHash'
                                        ], ce = (b = G, Object.keys(b).map(function (e) {
                                            return b[e];
                                        })), ue = function () {
                                            var r = {};
                                            ...
                                            var n = 1 < arguments.length && void 0 !== t && arguments[1];
                                            return !(!e || Ie(e)) && ve(e).every(function (e) {
                                            ...
                                            return void 0 === e || (Ee(e) ? ye(Object.keys(e), !0) : De(e));
                                        }, De = function (e) {
                                            try {
                                                var t = JSON.parse(e);
                                            ...
                                            return function (e) {
                                                var t = 0 < arguments.length && void 0 !== e ? arguments[0] : {}, n = t.command, r = t.params, i = void 0 === r ? {} : r, o = t.callback, a = void 0 === o ? Oe : o;
                                                if (!n || -1 === n.indexOf('.'))
                                    ...
                                    var Le = 'fetchPermissions', xe = '[OptIn#registerPlugin] Plugin is invalid.';
                                    l.Categories = G, l.TimeoutError = u;
                                    var je = Object.freeze({
                                                ...
                                                if (o.readyToAttachIframePreliminary()) {
                                                    if ('string' == typeof e) {
                                                        ...
                                                        c.forEach(function (e) {
                                                            J.isObject(e) && (e.hideReferrer ? e.message && o.addMessage(e.message) : u.push(e));
                                                        }), function l() {
                                                    ...
                                                    o.iframe ? (i({ message: 'The destination publishing iframe is already attached and loaded.' }), o.requestToProcess()) : !d.subdomain && d._getField('MCMID') ? (o.subdomain = e, o.doAttachIframe = !0, o.url = o.getUrl(), o.readyToAttachIframe() ? (o.iframeLoadedCallbacks.push(function (e) {
                                                    ...
                                                    }), o.attachIframe()) : i({ error: 'Encountered a problem in attempting to attach and load the destination publishing iframe through this API call.' })) : o.iframeLoadedCallbacks.push(function (e) {
                                            ...
                                            for (var n, r, i = Math.pow, o = i(2, 32), a = '', s = [], c = 8 * e.length, u = Y.h = Y.h || [], l = Y.k = Y.k || [], d = l.length, f = {}, p = 2; d < 64; p++)
                                                if (!f[p]) {
                                                    for (n = 0; n < 313; n += p)
                                                        f[n] = p;
                                    ...
                                    J.defineGlobalNamespace(), window.adobe.OptInCategories = Ue.Categories;
                                    var He = function (r, n, e) {
                                        ...
                                        function t(e) {
                                            ...
                                            return function (e) {
                                                ...
                                                try {
                                                    ...
                                                    if (n)
                                                        return U.parsePipeDelimetedKeyValues(n);
                                                } catch (e) {
                                                }
                                            };
                                        }
                                        function i(e) {
                                            function t(e, t, n) {
                                                e && e.match(re.VALID_VISITOR_ID_REGEX) && (n === k && (I = !0), t(e));
                                            }
                                            t(e[k], v.setMarketingCloudVisitorID, k), v._setFieldExpire(L, -1), t(e[w], v.setAnalyticsVisitorID);
                                        }
                                        function o(e) {
                                        ...
                                        function a(e) {
                                            ...
                                            var n, r = e.reduce(t, '');
                                            return (n = (n = r) ? n += '|' : n) + 'TS=' + U.getTimestampInSeconds();
                                        }
                                        function s(e) {
                                        ...
                                        var v = this, b = window.adobe, y = '', _ = 0, C = !1, I = !1;
                                        v.version = '5.2.0';
                                        var S = q, A = S.Visitor;
                                        A.version = v.version, A.AuthState = W.AUTH_STATE, A.OptOut = W.OPT_OUT, S.s_c_in || (S.s_c_il = [], S.s_c_in = 0), v._c = 'Visitor', v._il = S.s_c_il, v._in = S.s_c_in, v._il[v._in] = v, S.s_c_in++, v._instanceType = 'regular', v._log = { requests: [] }, v.marketingCloudOrgID = r, v.cookieName = 'AMCV_' + r, v.sessionCookieName = 'AMCVS_' + r;
                                        var D = {};
                                        n && n.secureCookie && n.sameSiteCookie && (D = {
                                            sameSite: n.sameSiteCookie,
                                            secure: n.secureCookie
                                        }), v.cookieDomain = v.useLocalStorage ? '' : Q(null, D), v.loadSSL = !0, v.loadTimeout = 30000, v.CORSErrors = [], v.marketingCloudServer = v.audienceManagerServer = 'dpm.demdex.net', v.sdidParamExpiry = 30;
                                        var E = null, O = 'MC', k = 'MCMID', M = 'MCIDTS', T = 'A', w = 'MCAID', P = 'AAM', L = 'MCAAMB', x = 'NONE', j = function (e) {
                                                return !Object.prototype[e];
                                            }, R = ne(v);
                                        v.FIELDS = W.FIELDS, v.cookieRead = function (e) {
                                            ...
                                            if (v.useLocalStorage)
                                                return e === v.sessionCookieName ? sessionStorage.setItem(e, r) : localStorage.setItem(e, r);
                                            var i = v.cookieLifetime ? ('' + v.cookieLifetime).toUpperCase() : '', o = {
                                                    expires: n,
                                                    domain: v.cookieDomain,
                                                    cookieLifetime: i
                                                };
                                            return v.configs && v.configs.secureCookie && 'https:' === location.protocol && (o.secure = !0), v.configs && v.configs.sameSiteCookie && 'https:' === location.protocol && (o.sameSite = W.SAME_SITE_VALUES[v.configs.sameSiteCookie.toUpperCase()] || 'Lax'), $.set(e, r, o);
                                            ...
                                            return v.configs && v.configs.secureCookie && 'https:' === location.protocol && (t.secure = !0), v.configs && v.configs.sameSiteCookie && 'https:' === location.protocol && (t.sameSite = W.SAME_SITE_VALUES[v.configs.sameSiteCookie.toUpperCase()] || 'Lax'), $.remove(e, t);
                                            ...
                                            return v._getRemoteField(k, r, e, t, n);
                                        };
                                        var N = function (t, e) {
                                            var n = {};
                                        ...
                                        v.getVisitorValues = function (e, t) {
                                            ...
                                            t && -1 === t.indexOf('MCAID') ? N(e, t) : K(r, e);
                                        }, v._currentCustomerIDs = {}, v._customerIDsHashChanged = !1, v._newCustomerIDsHash = '', v.setCustomerIDs = function (e, t) {
                                            if (!v.isOptedOut() && e) {
                                                if (!J.isObject(e) || J.isObjectEmpty(e))
                                                    return !1;
                                                var n, r, i, o;
                                                for (n in (v._readVisitor(), e))
                                                    if (j(n) && (v._currentCustomerIDs.dataSources = v._currentCustomerIDs.dataSources || {}, t = (r = e[n]).hasOwnProperty('hashType') ? r.hashType : t, r))
                                                        if ('object' === Y(r)) {
                                                            var a = {};
                                                            if (r.id) {
                                                                if (t) {
                                                            ...
                                                            null != r.authState && (a.authState = r.authState), v._currentCustomerIDs.dataSources[n] = a;
                                                        } else if (t) {
                                                            if (!(o = Fe(Ve(r), t)))
                                                                return;
                                                ...
                                                for (i in (c || (c = 0), s)) {
                                                    var l = s[i];
                                                    if (!J.isObjectEmpty(l))
                                                        for (n in l)
                                                            j(n) && (u += (u ? '|' : '') + n + '|' + ((r = l[n]).id ? r.id : '') + (r.authState ? r.authState : ''));
                                                }
                                            ...
                                            if (!v.isOptedOut() && e) {
                                                ...
                                                var n, r, i, o, a;
                                                for (n in (v._readVisitor(), e))
                                                    if (j(n) && (v._currentCustomerIDs.nameSpaces = v._currentCustomerIDs.nameSpaces || {}, t = (r = e[n]).hasOwnProperty('hashType') ? r.hashType : t, r && 'object' === Y(r))) {
                                                        var s = {};
                                                        if (r.id) {
                                                            if (t) {
                                                                if (!(i = Fe(Ve(r.id), t)))
                                                        ...
                                                        null != r.authState && (s.authState = r.authState), r.dataSource && (v._currentCustomerIDs.dataSources = v._currentCustomerIDs.dataSources || {}, o = r.dataSource, v._currentCustomerIDs.dataSources[o] = s), v._currentCustomerIDs.nameSpaces[n] = s;
                                                    }
                                                var c = v.getCustomerIDs(!0), u = v._getField('MCCIDH'), l = '';
                                                for (a in (u || (u = '0'), c)) {
                                                    var d = c[a];
                                                    if (!J.isObjectEmpty(d))
                                                        for (n in d)
                                                            j(n) && (l += (l ? '|' : '') + n + '|' + ((r = d[n]).id ? r.id : '') + (r.authState ? r.authState : ''));
                                                }
                                            ...
                                            for (t in i)
                                                j(t) && (n = i[t]).id && (r.dataSources[t] || (r.dataSources[t] = {}), r.dataSources[t].id = n.id, null != n.authState ? r.dataSources[t].authState = n.authState : r.dataSources[t].authState = A.AuthState.UNKNOWN, n.hashType && (r.dataSources[t].hashType = n.hashType));
                                            var o = v._currentCustomerIDs.nameSpaces;
                                            for (t in o)
                                                j(t) && (n = o[t]).id && (r.nameSpaces[t] || (r.nameSpaces[t] = {}), r.nameSpaces[t].id = n.id, null != n.authState ? r.nameSpaces[t].authState = n.authState : r.nameSpaces[t].authState = A.AuthState.UNKNOWN, n.hashType && (r.nameSpaces[t].hashType = n.hashType));
                                            return e ? r : r.dataSources;
                                        }, v.setAnalyticsVisitorID = function (e) {
                                            v._setAnalyticsFields(e);
                                        }, v.getAnalyticsVisitorID = function (e, t, n) {
                                            if (!U.isTrackingServerPopulated() && !n)
                                                return v._callCallback(e, ['']), '';
                                            var r = '';
                                            if (n || (r = v.getMarketingCloudVisitorID(function () {
                                                    v.getAnalyticsVisitorID(e, !0);
                                                })), r || n) {
                                                var i = n ? v.marketingCloudServer : v.trackingServer, o = '';
                                                ...
                                                if (i) {
                                                    ...
                                                    o = s + '?' + c + '&callback=s_c_il%5B' + v._in + '%5D._set' + (n ? 'MarketingCloud' : 'Analytics') + 'Fields', a.corsUrl = s + '?' + c, a.callback = u;
                                                }
                                                return a.url = o, v._getRemoteField(n ? k : w, o, e, t, a);
                                            }
                                            return '';
                                            ...
                                            if (v.getMarketingCloudVisitorID(function () {
                                                ...
                                                var n = v._getField(w);
                                                if (!n && U.isTrackingServerPopulated() && (n = v.getAnalyticsVisitorID(function () {
                                                        v.getAudienceManagerLocationHint(e, !0);
                                                    })), n || !U.isTrackingServerPopulated()) {
                                            ...
                                            if (v.getMarketingCloudVisitorID(function () {
                                                ...
                                                if (!n && U.isTrackingServerPopulated() && (n = v.getAnalyticsVisitorID(function () {
                                                    ...
                                                    var r = v._getAudienceManagerURLData(), i = r.url;
                                                    return v._customerIDsHashChanged && v._setFieldExpire(L, -1), v._getRemoteField(L, i, e, t, r);
                                                }
                                            }
                                            return '';
                                        ...
                                        var F = !(v.getSupplementalDataID = function (e, t) {
                                        ...
                                        v._liberatedOptOut = null, v.getOptOut = function (e, t) {
                                            ...
                                            if (v._registerCallback('liberatedOptOut', e), null !== v._liberatedOptOut)
                                                return v._callAllCallbacks('liberatedOptOut', [v._liberatedOptOut]), F = !1, v._liberatedOptOut;
                                            if (F)
                                                return null;
                                            F = !0;
                                            var i = 'liberatedGetOptOut';
                                            return n.corsUrl = n.corsUrl.replace(/\.demdex\.net\/id\?/, '.demdex.net/optOutStatus?'), n.callback = [i], q[i] = function (e) {
                                                if (e === Object(e)) {
                                                    var t, n, r = J.parseOptOut(e, t, x);
                                                    t = r.optOut, n = 1000 * r.d_ottl, v._liberatedOptOut = t, setTimeout(function () {
                                                        v._liberatedOptOut = null;
                                                    }, n);
                                                }
                                                v._callAllCallbacks('liberatedOptOut', [t]), F = !1;
                                            }, R.fireCORS(n), null;
                                        };
                                        var V = {
                                            subscribed: (v.isOptedOut = function (n, r, e) {
                                                r || (r = A.OptOut.GLOBAL);
                                        ...
                                        v.onReceiveEcid = function (e) {
                                            ...
                                            V.subscribed = !0, e && 'function' == typeof e && V.callbacks.push(e);
                                            ...
                                            return G.isClientSideMarketingCloudVisitorID = !0, e;
                                            ...
                                            var i = encodeURIComponent(t) + '=' + encodeURIComponent(n), o = U.parseHash(e), a = U.hashlessUrl(e);
                                            if (-1 === a.indexOf('?'))
                                                return a + '?' + i + o;
                                            var s = a.split('?'), c = s[0] + '?', u = s[1];
                                            return c + U.addQueryParamAtLocation(u, i, r) + o;
                                        }, v._extractParamFromUri = function (e, t) {
                                            var n = new RegExp('[\\?&#]' + t + '=([^&#]*)').exec(e);
                                            if (n && n.length)
                                                return decodeURIComponent(n[1]);
                                        }, v._parseAdobeMcFromUrl = t(re.ADOBE_MC), v._parseAdobeMcSdidFromUrl = t(re.ADOBE_MC_SDID), v._attemptToPopulateSdidFromUrl = function (e) {
                                            var t = v._parseAdobeMcSdidFromUrl(e), n = 1000000000;
                                            t && t.TS && (n = U.getTimestampInSeconds() - t.TS), t && t.SDID && t.MCORGID === r && n < v.sdidParamExpiry && (v._supplementalDataIDCurrent = t.SDID, v._supplementalDataIDCurrentConsumed.SDID_URL_PARAM = !0);
                                        }, v._attemptToPopulateIdsFromUrl = function () {
                                            var e = v._parseAdobeMcFromUrl();
                                            if (e && e.TS) {
                                                var t = U.getTimestampInSeconds() - e.TS;
                                                if (Math.floor(t / 60) > re.ADOBE_MC_TTL_IN_MIN || e.MCORGID !== r)
                                                    return;
                                                i(e);
                                            }
                                            ...
                                            if (e)
                                                try {
                                                    if (r = e, (e = U.isObject(r) ? r : JSON.parse(r))[v.marketingCloudOrgID]) {
                                                        var t = e[v.marketingCloudOrgID];
                                                        n = t.customerIDs, U.isObject(n) && v.setCustomerIDs(n), o(t.sdid);
                                                    }
                                                } catch (e) {
                                            ...
                                            t = v._addQuerystringParam(t, 'd_fieldgroup', e, 1), r.url = v._addQuerystringParam(r.url, 'd_fieldgroup', e, 1), r.corsUrl = v._addQuerystringParam(r.corsUrl, 'd_fieldgroup', e, 1), G.fieldGroupObj[e] = !0, r === Object(r) && r.corsUrl && 'XMLHttpRequest' === R.corsMetadata.corsType && R.fireCORS(r, n, e);
                                            ...
                                            if (!v._readVisitorDone) {
                                                ...
                                                var e, t, n, r, i, o, a = v._getSettingsDigest(), s = !1, c = v.cookieRead(v.cookieName), u = new Date();
                                                if (c || I || v.discardTrackingServerECID || (c = v.cookieRead(re.FIRST_PARTY_SERVER_COOKIE)), null == v._fields && (v._fields = {}), c && 'T' !== c)
                                                    for ((c = c.split('|'))[0].match(/^[\-0-9]+$/) && (parseInt(c[0], 10) !== a && (s = !0), c.shift()), c.length % 2 == 1 && c.pop(), e = 0; e < c.length; e += 2)
                                                        n = (t = c[e].split('-'))[0], r = c[e + 1], 1 < t.length ? (i = parseInt(t[1], 10), o = 0 < t[1].indexOf('s')) : (i = 0, o = !1), s && ('MCCIDH' === n && (r = ''), 0 < i && (i = u.getTime() / 1000 - 60)), n && r && (v._setField(n, r, 1), 0 < i && (v._fields['expire' + n] = i + (o ? 's' : ''), (u.getTime() >= 1000 * i || o && !v.cookieRead(v.sessionCookieName)) && (v._fieldsExpired || (v._fieldsExpired = {}), v._fieldsExpired[n] = !0)));
                                                !v._getField(w) && U.isTrackingServerPopulated() && (c = v.cookieRead('s_vi')) && 1 < (c = c.split('|')).length && 0 <= c[0].indexOf('v1') && (0 <= (e = (r = c[1]).indexOf('[')) && (r = r.substring(0, e)), r && r.match(re.VALID_VISITOR_ID_REGEX) && v._setField(w, r));
                                            }
                                        }, v._appendVersionTo = function (e) {
                                            var t = 'vVersion|' + v.version, n = e ? v._getCookieVersion(e) : null;
                                            return n ? Z.areVersionsDifferent(n, v.version) && (e = e.replace(re.VERSION_REGEX, t)) : e += (e ? '|' : '') + t, e;
                                        }, v._writeVisitor = function () {
                                            var e, t, n = v._getSettingsDigest();
                                            for (e in v._fields)
                                                j(e) && v._fields[e] && 'expire' !== e.substring(0, 6) && (t = v._fields[e], n += (n ? '|' : '') + e + (v._fields['expire' + e] ? '-' + v._fields['expire' + e] : '') + '|' + t);
                                            ...
                                            return e && ('object' === Y(e) && (e = e.d_mid ? e.d_mid : e.visitorID ? e.visitorID : e.id ? e.id : e.uuid ? e.uuid : '' + e), e && 'NOTARGET' === (e = e.toUpperCase()) && (e = x), e && (e === x || e.match(re.VALID_VISITOR_ID_REGEX)) || (e = '')), e;
                                        }, v._setFields = function (e, t) {
                                            if (v._clearTimeout(e), null != v._loading && (v._loading[e] = !1), G.fieldGroupObj[e] && G.setState(e, !1), e === O) {
                                                !0 !== G.isClientSideMarketingCloudVisitorID && (G.isClientSideMarketingCloudVisitorID = !1);
                                                var n = v._getField(k);
                                                if (!n || v.overwriteCrossDomainMCIDAndAID) {
                                                    if (!(n = 'object' === Y(t) && t.mid ? t.mid : v._findVisitorID(t))) {
                                                ...
                                                n && n !== x || (n = ''), 'object' === Y(t) && ((t.d_region || t.dcs_region || t.d_blob || t.blob) && v._setFields(P, t), v._use1stPartyMarketingCloudServer && t.mid && v._setFields(T, { id: t.id })), v._callAllCallbacks(k, [n]);
                                            }
                                            if (e === P && 'object' === Y(t)) {
                                                var r = 604800;
                                                null != t.id_sync_ttl && t.id_sync_ttl && (r = parseInt(t.id_sync_ttl, 10));
                                                var i = H.getRegionAndCheckIfChanged(t, r);
                                                v._callAllCallbacks('MCAAMLH', [i]);
                                                var o = v._getField(L);
                                                (t.d_blob || t.blob) && ((o = t.d_blob) || (o = t.blob), v._setFieldExpire(L, r), v._setField(L, o)), o || (o = ''), v._callAllCallbacks(L, [o]), !t.error_msg && v._newCustomerIDsHash && v._setField('MCCIDH', v._newCustomerIDsHash);
                                            }
                                            if (e === T) {
                                                var a = v._getField(w);
                                                a && !v.overwriteCrossDomainMCIDAndAID || ((a = v._findVisitorID(t)) ? a !== x && v._setFieldExpire(L, -1) : a = x, v._setField(w, a)), a && a !== x || (a = ''), v._callAllCallbacks(w, [a]);
                                            }
                                            if (v.idSyncDisableSyncs || v.disableIdSyncs)
                                                H.idCallNotProcesssed = !0;
                                            else {
                                                H.idCallNotProcesssed = !1;
                                                var s = {};
                                                s.ibs = t.ibs, s.subdomain = t.subdomain, H.processIDCallData(s);
                                            }
                                            if (t === Object(t)) {
                                                var c, u;
                                                d() && v.isAllowed() && (c = v._getField('MCOPTOUT'));
                                                var l = J.parseOptOut(t, c, x);
                                            ...
                                            var o, a = '', s = U.isFirstPartyAnalyticsVisitorIDCall(n), c = {
                                                    MCAAMLH: !0,
                                                    MCAAMB: !0
                                                };
                                            if (d() && v.isAllowed())
                                                if (v._readVisitor(), !(!(a = v._getField(n, !0 === c[n])) || v._fieldsExpired && v._fieldsExpired[n]) || v.disableThirdPartyCalls && !s)
                                                    a || (n === k ? (v._registerCallback(n, t), a = v._generateLocalMID(), v.setMarketingCloudVisitorID(a)) : n === w ? (v._registerCallback(n, t), a = '', v.setAnalyticsVisitorID(a)) : r = !(a = ''));
                                                else if (n === k || 'MCOPTOUT' === n ? o = O : 'MCAAMLH' === n || n === L ? o = P : n === w && (o = T), o)
                                                    return !e || null != v._loading && v._loading[o] || (null == v._loading && (v._loading = {}), v._loading[o] = !0, o === P && (_ = 0), v._loadData(o, e, function (e) {
                                                        if (!v._getField(n)) {
                                                            e && G.setState(o, !0);
                                                            var t = '';
                                                            n === k ? t = v._generateLocalMID() : o === P && (t = { error_msg: 'timeout' }), v._setFields(o, t);
                                                        }
                                                    }, i)), v._registerCallback(n, t), a || (e || v._setFields(o, { id: x }), '');
                                            return n !== k && n !== w || a !== x || (r = !(a = '')), t && r && v._callCallback(t, [a]), n === k && V.subscribed && (V.callbacks && V.callbacks.length && V.callbacks.forEach(function (e) {
                                                v._callCallback(e, [a]);
                                            }), V.subscribed = !1, V.callbacks.length = 0), a;
                                            ...
                                            var t = v.audienceManagerServer, n = '', r = v._getField(k), i = v._getField(L, !0), o = v._getField(w), a = o && o !== x ? '&d_cid_ic=AVID%01' + encodeURIComponent(o) : '';
                                            ...
                                            try {
                                                ...
                                                return v._addQuerystringParam(e, re.ADOBE_MC, a(t));
                                            } catch (t) {
                                                return e;
                                            }
                                        }, v.appendSupplementalDataIDTo = function (e, t) {
                                            if (!(t = t || v.getSupplementalDataID(U.generateRandomString(), !0)))
                                                return e;
                                            try {
                                                var n = a([
                                                    [
                                                ...
                                                return v._addQuerystringParam(e, re.ADOBE_MC_SDID, n);
                                            } catch (t) {
                                                return e;
                                            }
                                        };
                                        var U = {
                                            ...
                                            isFirstPartyAnalyticsVisitorIDCall: function (e, t, n) {
                                                return e === w && (t || (t = v.trackingServer), n || (n = v.trackingServerSecure), !('string' != typeof (r = v.loadSSL ? n : t) || !r.length) && r.indexOf('2o7.net') < 0 && r.indexOf('omtrdc.net') < 0);
                                                var r;
                                            },
                                            isObject: function (e) {
                                        ...
                                        v._helpers = U;
                                        var H = ie(v, A);
                                        v._destinationPublishing = H, v.timeoutMetricsLog = [];
                                        var B, G = {
                                        ...
                                        v.isClientSideMarketingCloudVisitorID = function () {
                                            ...
                                            if (!v.isOptedOut()) {
                                                ...
                                                if (t.error)
                                                    return t.error;
                                                var n, r, i = e.url, o = encodeURIComponent, a = H;
                                                return i = i.replace(/^https:/, '').replace(/^http:/, ''), n = J.encodeAndBuildRequest([
                                                    '',
                                                    e.dpid,
                                                    e.dpuuid || ''
                                                ], ','), r = [
                                                    ...
                                                    '',
                                                    n
                                                ], a.addMessage(r.join('|')), a.requestToProcess(), 'Successfully queued';
                                            }
                                        ...
                                        }, Re(v, H), v._getCookieVersion = function (e) {
                                            ...
                                            if (v.configs = Object.create(null), U.isObject(n))
                                                for (var e in n)
                                                    j(e) && (v[e] = n[e], v.configs[e] = n[e]);
                                        }(), u(), v.init = function () {
                                            c() && (b.optIn.fetchPermissions(m, !0), !b.optIn.isApproved(b.optIn.Categories.ECID)) || B || (B = !0, function () {
                                                if (U.isObject(n)) {
                                                    v.idSyncContainerID = v.idSyncContainerID || 0, E = 'boolean' == typeof v.isCoopSafe ? v.isCoopSafe : U.parseBoolean(v.isCoopSafe), v.resetBeforeVersion && v._resetAmcvCookie(v.resetBeforeVersion), v._attemptToPopulateIdsFromUrl(), v._attemptToPopulateSdidFromUrl(), v._readVisitor();
                                                    var e = v._getField(M), t = Math.ceil(new Date().getTime() / re.MILLIS_PER_DAY);
                                                    v.idSyncDisableSyncs || v.disableIdSyncs || !H.canMakeSyncIDCall(e, t) || (v._setFieldExpire(L, -1), v._setField(M, t)), v.getMarketingCloudVisitorID(), v.getAudienceManagerLocationHint(), v.getAudienceManagerBlob(), v._mergeServerState(v.serverState);
                                                } else
                                                ...
                                                if (!v.idSyncDisableSyncs && !v.disableIdSyncs) {
                                                    ...
                                                    try {
                                                        ee.receiveMessage(function (e) {
                                                            H.receiveMessage(e.data);
                                                        }, H.iframeHost);
                                                    } catch (e) {
                                                    }
                                                }
                                            }(), v.whitelistIframeDomains && re.POST_MESSAGE_ENABLED && (v.whitelistIframeDomains = v.whitelistIframeDomains instanceof Array ? v.whitelistIframeDomains : [v.whitelistIframeDomains], v.whitelistIframeDomains.forEach(function (e) {
                                                var t = new X(r, e), n = z(v, t);
                                                ee.receiveMessage(n, e);
                                            })));
                                        };
                                    };
                                    He.config = U;
                                    var Be = q.Visitor = He, Ge = function (i) {
                                            if (J.isObject(i))
                                                return Object.keys(i).filter(function (e) {
                                                    return '' !== i[e] && U.getConfigs()[e];
                                                }).reduce(function (e, t) {
                                                    var n = U.normalizeConfig(t, i[t]), r = J.normalizeBoolean(n);
                                                    return e[t] = r, e;
                                                }, Object.create(null));
                                        }, Ye = je.OptIn, qe = je.IabPlugin;
                                    Be.getInstance = function (r, e) {
                                        ...
                                        if (t)
                                            return t;
                                        var i, n = Ge(e) || {};
                                        i = n || {}, q.adobe.optIn = q.adobe.optIn || function () {
                                            var e = J.pluck(i, [
                                                    'doesOptInApply',
                                                    'previousPermissions',
                                                    'preOptInApprovals',
                                        ...
                                        var o = r.split('').reverse().join(''), a = new Be(r, null, o);
                                        n.cookieDomain && (a.cookieDomain = n.cookieDomain), n.sameSiteCookie && n.secureCookie && (a.configs = {
                                        ...
                                        var c, u = function () {
                                            ...
                                            }() && ((c = a).cookieWrite('TEST_AMCV_COOKIE', 'T', 1), 'T' !== c.cookieRead('TEST_AMCV_COOKIE') || (c.removeCookie('TEST_AMCV_COOKIE'), 0)) && q.parent ? new P(r, n, a, q.parent) : new Be(r, n, o);
                                        return a = null, u.init(), u;
                                    }, function () {
                                        function e() {
                                            Be.windowLoaded = !0;
                                        }
                                        q.addEventListener ? q.addEventListener('load', e) : q.attachEvent && q.attachEvent('onload', e), Be.codeLoadEnd = new Date().getTime();
                                    }();
                                }(), Visitor);
                            }
                        },
                    ...
                    settings: { orgId: '0AAF22CE52827A080A490D4D@AdobeOrg' },
                    hostedLibFilesBaseUrl: 'https://assets.adobedtm.com/extensions/EPf0412a5c65e5429ab0e5ed8ba2256510/'
                }
            },
            company: { orgId: '0AAF22CE52827A080A490D4D@AdobeOrg' },
            property: {
                name: 'Tangerine',
                settings: {
                    domains: ['tangerine.ca'],
                    undefinedVarsReturnEmpty: !1,
                    ruleComponentSequencingEnabled: !0
                }
            },
            rules: [{
                    id: 'RLa6ce0f95b23143ecbd10b700e0f0d206',
                    name: 'send AA beacon on all pages',
                    events: [{
        ...
        var $___var_e32d91825d47054a = function () {
            'use strict';
            function e(n) {
                if (n.__esModule)
                    return n;
            ...
            if (window.atob) {
                var h = function (e) {
                    ...
                    }, y = 'Module did not export a function.', _ = function (o, a) {
                        ...
                        WARN: 'warn',
                        ERROR: 'error'
                    }, S = '\uD83D\uDE80', A = 10 === parseInt((/msie (\d+)/.exec(navigator.userAgent.toLowerCase()) || [])[1]) ? '[Launch]' : S, D = !1, E = function (e) {
                        if (D && window.console) {
                            var t = Array.prototype.slice.call(arguments, 1);
                            t.unshift(A), e !== I.DEBUG || window.console[e] || (e = I.INFO), window.console[e].apply(window.console, t);
                        }
                    }, O = E.bind(null, I.LOG), k = E.bind(null, I.INFO), M = E.bind(null, I.DEBUG), T = E.bind(null, I.WARN), w = E.bind(null, I.ERROR), P = {
                        log: O,
                        info: k,
                        debug: M,
                        warn: T,
                        ...
                        deprecation: function () {
                            var e = D;
                            D = !0, E.apply(null, Array.prototype.concat(I.WARN, Array.prototype.slice.call(arguments))), e || (D = !1);
                        },
                        get outputEnabled() {
                            return D;
                        },
                    ...
                    }, L = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : {}, x = t(function (r) {
                        !function (e) {
                            if (r.exports = e(), !!0) {
                        ...
                        set: x.set,
                        remove: x.remove
                    }, R = window, N = 'com.adobe.reactor.', F = function (r, e) {
                        var i = N + (e || '');
                        return {
                            getItem: function (e) {
                                const $___old_68325be7ab0b83d3 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                                try {
                                    if ($___old_68325be7ab0b83d3)
                                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_ad28430541c1d11b.localStorage));
                                    return function () {
                                        try {
                                            return R[r].getItem(i + e);
                                        } catch (t) {
                                            return null;
                                        }
                                    }.apply(this, arguments);
                                    ...
                                    if ($___old_68325be7ab0b83d3)
                                        ({}.constructor.defineProperty(window, 'localStorage', $___old_68325be7ab0b83d3));
                                }
                            },
                            setItem: function (e, t) {
                                const $___old_dc75f3a3cedccd9d = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                                try {
                                    if ($___old_dc75f3a3cedccd9d)
                                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_ad28430541c1d11b.localStorage));
                                    return function () {
                                        try {
                                            return R[r].setItem(i + e, t), !0;
                                        } catch (n) {
                                            return !1;
                                        }
                                    }.apply(this, arguments);
                                    ...
                                    if ($___old_dc75f3a3cedccd9d)
                                        ({}.constructor.defineProperty(window, 'localStorage', $___old_dc75f3a3cedccd9d));
                                }
                            }
                        };
                    }, V = '_sdsat_', U = 'dataElements.', H = 'dataElementCookiesMigrated', B = F('localStorage'), G = F('sessionStorage', U), Y = F('localStorage', U), q = {
                        PAGEVIEW: 'pageview',
                        SESSION: 'session',
                        VISITOR: 'visitor'
                    }, W = {}, J = function (e) {
                        ...
                        case q.PAGEVIEW:
                            return void (W[e] = n);
                        case q.SESSION:
                            return void ((r = J(n)) && G.setItem(e, r));
                        case q.VISITOR:
                            return void ((r = J(n)) && Y.setItem(e, r));
                        }
                    }, z = function (e, t) {
                        var n = j.get(V + e);
                        n !== undefined && X(e, t, n);
                        ...
                        return function (e, t) {
                            ...
                            try {
                                ...
                                return void P.error($(n, e, a.message, a.stack));
                            }
                            if ('function' == typeof r) {
                                var o;
                                try {
                                ...
                                return i && (null != o ? K.setValue(e, i, o) : o = K.getValue(e, i)), null == o && null != n.defaultValue && (o = n.defaultValue), 'string' == typeof o && (n.cleanText && (o = C(o)), n.forceLowerCase && (o = o.toLowerCase())), o;
                            }
                            P.error($(n, e, 'Module did not export a function.'));
                        };
                    }, Z = {
                        text: function (e) {
                        ...
                        return function (e, t) {
                            ...
                            if (a(e))
                                ...
                                'this' === i ? t && (n = ee(t.element, r, !0)) : 'event' === i ? t && (n = ee(t, r)) : 'target' === i ? t && (n = ee(t.target, r)) : n = ee(o[i], r);
                            }
                            return n;
                        };
                    }, ne = function (n, r) {
                        ...
                        return function (t, n) {
                            var e = r._monitors;
                            e && (oe || (P.warn('The _satellite._monitors API may change at any time and should only be used for debugging.'), oe = !0), e.forEach(function (e) {
                                e[t] && e[t](n);
                            }));
                        };
                    }, se = function (i, o, a) {
                        ...
                        return n = function (e, n) {
                            ...
                            return 10 < u.length ? (P.error('Data element circular reference detected: ' + u.join(' -> ')), e) : c(e, t);
                        };
                    }, ce = function (i) {
                        return function (e, t) {
                            if ('string' == typeof e)
                ...
                o.prototype['catch'] = function (e) {
                ...
                }, o.prototype['finally'] = n, o.all = function (t) {
                    ...
                    ue(e, 0);
                }, o._unhandledRejectionFn = function Ot(e) {
                    'undefined' != typeof console && console && console.warn('Possible Unhandled Promise Rejection:', e);
                };
                var le = e(Object.freeze({
                        __proto__: null,
                        'default': o
                    })), de = 'undefined' != typeof window && window.Promise || void 0 !== L && L.Promise || le['default'] || le, fe = function (u, n, r) {
                        return function (s, t, c, e) {
                            return e.then(function () {
                                ...
                                return new de(function (e, t) {
                                    ...
                                    return clearTimeout(o), e = n(e), r(s, t, e), de.reject(e);
                                }).then(function () {
                                    clearTimeout(o);
                                });
                            });
                        ...
                        return function (a, t, s, e) {
                            return e.then(function () {
                                var o;
                                return new de(function (e, t) {
                                    var n = c(a, s, [s]), r = a.timeout, i = new de(function (e, t) {
                                            o = setTimeout(function () {
                                    ...
                                    return clearTimeout(o), e = n(e), i(a, t, e), de.reject(e);
                                }).then(function (e) {
                                    if (clearTimeout(o), !r(a, e))
                                        return u(a, t), de.reject();
                                });
                            });
                        };
                        ...
                        return function (e, t, n) {
                            var r = o(e);
                            a.error(i(r, t.name, n)), s('ruleActionFailed', {
                                rule: t,
                                action: e
                            });
                        };
                        ...
                        return function (e, t, n) {
                            var r = o(e);
                            a.error(i(r, t.name, n)), s('ruleConditionFailed', {
                                rule: t,
                                condition: e
                            });
                        };
                        ...
                        return function (e, t) {
                            var n = r(e);
                            i.log('Condition "' + n + '" for rule "' + t.name + '" was not met.'), o('ruleConditionFailed', {
                                rule: t,
                                condition: e
                            });
                        };
                    ...
                    }, Te = [], we = !1, Pe = function (e) {
                        we ? e() : Te.push(e);
                    }, Le = function (e, t, n) {
                        e(t).forEach(function (e) {
                            n(Pe, e);
                        }), we = !0, Te.forEach(function (e) {
                            e();
                        }), Te = [];
                    }, xe = function (e) {
                        ...
                        return e;
                    }, je = Object.getOwnPropertySymbols, Re = Object.prototype.hasOwnProperty, Ne = Object.prototype.propertyIsEnumerable, Fe = g() ? Object.assign : function (e) {
                        for (var t, n, r = p(e), i = 1; i < arguments.length; i++) {
                            for (var o in t = Object(arguments[i]))
                                Re.call(t, o) && (r[o] = t[o]);
                            if (je) {
                                n = je(t);
                                for (var a = 0; a < n.length; a++)
                                    Ne.call(t, n[a]) && (r[n[a]] = t[n[a]]);
                            }
                        }
                        return r;
                    }, Ve = function (e, t) {
                        return Fe(t = t || {}, e), t.hasOwnProperty('type') || Object.defineProperty(t, 'type', {
                            get: function () {
                                return P.deprecation('Accessing event.type in Adobe Launch has been deprecated and will be removed soon. Please use event.$type instead.'), t.$type;
                            }
                        }), t;
                    }, Ue = function (c, u) {
                        return function (e, t) {
                        ...
                        qe(t, Ge) || (t += Ge);
                        var n = t.split('/'), r = Ye(e).split('/');
                        return n.forEach(function (e) {
                            e && '.' !== e && ('..' === e ? r.length && r.pop() : r.push(e));
                        }), r.join('/');
                    }, Je = document, Xe = function (n, r) {
                        return new de(function (e, t) {
                            r.onload = function () {
                                e(r);
                            }, r.onerror = function () {
                        ...
                        0 < a && a < s && (s = a);
                        for (var c = 0; c < s; ++c) {
                            var u, l, d, f, p = e[c].replace(o, '%20'), g = p.indexOf(n);
                        ...
                        t.decode = t.parse = Ke, t.encode = t.stringify = Qe;
                    }), et = '@adobe/reactor-', tt = {
                        cookie: j,
                        document: Je,
                        'load-script': ze,
                    ...
                    }, rt = function (e, a, s, c, u) {
                        var l = e.extensions, d = e.buildInfo, f = e.property.settings;
                        if (l) {
                            var p = Ue(l, a);
                            Object.keys(l).forEach(function (r) {
                                var i = l[r], e = He(c, i.settings);
                                if (i.modules) {
                                    var t = P.createPrefixedLogger(i.displayName), n = Be(i.hostedLibFilesBaseUrl, d.minified), o = {
                                            buildInfo: d,
                        ...
                        var o = P.createPrefixedLogger('Custom Script');
                        e.track = function (e) {
                            ...
                            switch (P.deprecation('_satellite.notify is deprecated. Please use the `_satellite.logger` API.'), t) {
                            case 3:
                                o.info(e);
                                break;
                            case 4:
                            ...
                            P.deprecation(o), j.set(e, t, i);
                        }, e.readCookie = function (e) {
                            return P.deprecation('_satellite.readCookie is deprecated. Please use _satellite.cookie.get("' + e + '").'), j.get(e);
                        }, e.removeCookie = function (e) {
                            P.deprecation('_satellite.removeCookie is deprecated. Please use _satellite.cookie.remove("' + e + '").'), j.remove(e);
                        }, e.cookie = j, e.pageBottom = function () {
                        }, e.setDebug = n;
                        var a = !1;
                        Object.defineProperty(e, '_container', {
                            get: function () {
                                return a || (P.warn('_satellite._container may change at any time and should only be used for debugging.'), a = !0), t;
                            }
                        });
                ...
                if (ot && !window.__satelliteLoaded) {
                    ...
                    var at = ot.container;
                    delete ot.container;
                    var st = at.property.settings.undefinedVarsReturnEmpty, ct = at.property.settings.ruleComponentSequencingEnabled, ut = at.dataElements || {};
                    K.migrateCookieData(ut);
                    var lt, dt = function (e) {
                            return ut[e];
                        }, ft = ie(), pt = Q(ft, dt, function () {
                            return lt.apply(null, arguments);
                        }, st), gt = {}, mt = ce(gt), ht = ne(gt, dt), vt = te(gt, dt, pt);
                    lt = se(ht, vt, st);
                    var bt = b(F('localStorage'), P);
                    it(ot, at, bt.setDebugEnabled, vt, mt), rt(at, ft, bt, lt, pt);
                    var yt = ae(ot), _t = _(ft, lt), Ct = ye(ft), It = Ae(Ct, P, yt), St = Se(ke, Ct, P, yt), At = Ie(ke, Ct, P, yt), Dt = De(P, yt), Et = Ce(Oe(ct, be(ve(_t, Me, It, St), Ee(_t, At, Dt)), me(pe(_t, xe, Me, St, It), fe(_t, xe, At), Dt), yt), _t, Ve, ke, _e(ft), P);
                    Le(h, at.rules || [], Et);
                }
                return ot;
            }
        ...
        _satellite = $___var_e32d91825d47054a;
    }())
}