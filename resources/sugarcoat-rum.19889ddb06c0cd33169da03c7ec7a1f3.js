{
    const $___mock_09674569d44d4090 = {};
    (exports => {
        'use strict';
        let isSealed = false;
        class Storage {
        ...
        isSealed = true;
    })($___mock_09674569d44d4090);
    const $___mock_32dac3e59067116f = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
            ...
            1: [
                function (t, e, n) {
                    const $___old_6736ae557d4d385f = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                    try {
                        if ($___old_6736ae557d4d385f)
                            ({}.constructor.defineProperty(window, 'localStorage', $___mock_09674569d44d4090.localStorage));
                        return function () {
                            function r(t) {
                                try {
                        ...
                        if ($___old_6736ae557d4d385f)
                            ({}.constructor.defineProperty(window, 'localStorage', $___old_6736ae557d4d385f));
                    }
                },
                {}
            ],
            2: [
                function (t, e, n) {
                    ...
                    var i = t('handle'), a = t(24), s = t('ee'), c = t('loader'), f = t('gos'), u = window.onerror, d = !1, p = 'nr@seenError', l = 0;
            ...
            4: [
                function (t, e, n) {
                    ...
                    var s = '-start', c = '-end', f = '-body', u = 'fn' + s, d = 'fn' + c, p = 'cb' + s, l = 'cb' + c, h = 'jsTime', m = 'fetch', v = 'addEventListener', w = window, y = w.location, x = t('loader');
                    if (w[v] && x.xhrWrappable) {
                        var g = t(10), b = t(11), E = t(8), R = t(6), O = t(13), C = t(7), P = t(14), T = t(9), N = t('ee'), S = N.get('tracer');
                        t(16), x.features.spa = !0;
                        var L, j = 0;
                        N.on(u, r), N.on(p, r), N.on(d, o), N.on(l, o), N.buffer([
                            u,
                            d,
                            'xhr-done',
                            'xhr-resolved'
                            ...
                            m + f + s,
                            m + f + c
                        ]), E.buffer(['newURL']), g.buffer([u]), b.buffer([
                            'propagate',
                            p,
                            l,
                            'executor-err',
                            ...
                            'jsonp-error',
                            'jsonp-end'
                        ]), a(P, 'send-xhr' + s), a(N, 'xhr-resolved'), a(N, 'xhr-done'), a(C, m + s), a(C, m + '-done'), a(T, 'new-jsonp'), a(T, 'jsonp-end'), a(T, 'cb-start'), E.on('pushState-end', i), E.on('replaceState-end', i), w[v]('hashchange', i, !0), w[v]('load', i, !0), w[v]('popstate', function () {
                            i(0, j > 1);
                        }, !0);
                    }
                },
            ...
            5: [
                function (t, e, n) {
                    ...
                    if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
                        var o = t('ee'), i = t('handle'), a = t(13), s = t(12), c = 'learResourceTimings', f = 'addEventListener', u = 'resourcetimingbufferfull', d = 'bstResource', p = 'resource', l = '-start', h = '-end', m = 'fn' + l, v = 'fn' + h, w = 'bstTimer', y = 'pushState', x = t('loader');
            ...
            6: [
                function (t, e, n) {
                    const $___old_7fd66b90f01c238c = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_7fd66b90f01c238c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_32dac3e59067116f.XMLHttpRequest));
                        return function () {
                            function r(t) {
                            ...
                            var a = t('ee').get('events'), s = t(26)(a, !0), c = t('gos'), f = XMLHttpRequest, u = 'addEventListener', d = 'removeEventListener';
                        ...
                        if ($___old_7fd66b90f01c238c)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7fd66b90f01c238c));
                    }
                },
                {}
            ],
            7: [
                function (t, e, n) {
                    ...
                    e.exports = o;
                    var a = window, s = 'fetch-', c = s + 'body-', f = [
                            'arrayBuffer',
                            'blob',
                            'json',
                            'text',
                    ...
                    u && d && p && (i(f, function (t, e) {
                        ...
                        if (e) {
                            ...
                            null !== r && (n.rxSize = r), o.emit(s + 'done', [
                                null,
                                e
                            ], n);
                        } else
            ...
            8: [
                function (t, e, n) {
                    ...
                    i && i.pushState && i.replaceState && (a = i), o.inPlace(a, [
                        'pushState',
                        'replaceState'
                    ], '-');
                },
            ...
            11: [
                function (t, e, n) {
                    ...
                    e.exports = a, f && (window.Promise = r, [
                        'all',
                        'race'
                    ].forEach(function (t) {
                        var e = f[t];
            ...
            13: [
                function (t, e, n) {
                    ...
                    var i = t('ee').get('timer'), a = t(26)(i), s = 'setTimeout', c = 'setInterval', f = 'clearTimeout', u = '-start', d = '-';
                    e.exports = i, a.inPlace(window, [
                        s,
                        'setImmediate'
                    ], s + d), a.inPlace(window, [c], c + d), a.inPlace(window, [
                        f,
                        'clearImmediate'
                    ], f + d), i.on(c + u, r), i.on(s + u, o);
                },
                {}
            ],
            14: [
                function (t, e, n) {
                    ...
                    t(6);
                    var f = t('ee'), u = f.get('xhr'), d = t(26)(u), p = NREUM.o, l = p.XHR, h = p.MO, m = p.PR, v = p.SI, w = 'readystatechange', y = [
                            'onload',
                            'onerror',
                            'onabort',
                            'onloadstart',
                    ...
                    var g = window.XMLHttpRequest = function (t) {
                        const $___old_483c98b1a76aff8b = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                        try {
                            if ($___old_483c98b1a76aff8b)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_32dac3e59067116f.XMLHttpRequest));
                            return function () {
                                var e = new l(t);
                                try {
                            ...
                            if ($___old_483c98b1a76aff8b)
                                ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_483c98b1a76aff8b));
                        }
                    };
                    if (c(l, g), g.prototype = l.prototype, d.inPlace(g.prototype, [
                            'open',
                            'send'
            ...
            15: [
                function (t, e, n) {
                    function r() {
                        var t = window.NREUM, e = t.info.accountID || null, n = t.info.agentID || null, r = t.info.trustKey || null, i = 'btoa' in window && 'function' == typeof window.btoa;
                        if (!e || !n || !i)
                            return null;
                        var a = {
                            v: [
                ...
                function (t, e, n) {
                    function r(t) {
                        ...
                        if (!this.ended) {
                            ...
                            e.aborted || (n.duration = s.now() - this.startTime, this.loadCaptureCalled || 4 !== t.readyState ? null == e.status && (e.status = 0) : a(this, t), n.cbTime = this.cbTime, d.emit('xhr-done', [t], t), c('xhr', [
                                e,
                                n,
                                this.startTime
                            ]));
                    ...
                    var s = t('loader');
                    if (s.xhrWrappable) {
                        var c = t('handle'), f = t(17), u = t(15).generateTraceHeader, d = t('ee'), p = [
                                'load',
                                'error',
                                'abort',
                                'timeout'
                            ], l = p.length, h = t('id'), m = t(20), v = t(19), w = window.XMLHttpRequest;
                        s.features.xhr = !0, t(14), d.on('new-xhr', function (t) {
                            ...
                            e instanceof w && 'load' === t[0] && d.emit('xhr-load-added', [
                                t[1],
                                t[2]
                            ], e);
                        }), d.on('removeEventListener-end', function (t, e) {
                            e instanceof w && 'load' === t[0] && d.emit('xhr-load-removed', [
                                t[1],
                                t[2]
                            ], e);
                            ...
                            this.xhrCbStart && d.emit('xhr-cb-time', [
                                s.now() - this.xhrCbStart,
                                this.onload,
                                e
                            ], e);
                        });
            ...
            18: [
                function (t, e, n) {
                    ...
                    a('actionText,setName,setAttribute,save,ignore,onEnd,getContext,end,get'.split(','), function (t, e) {
                        ...
                        'string' == typeof t && (t = new Error(t)), i('err', [
                            t,
                            f.now(),
                            !1,
                            e
            ...
            26: [
                function (t, e, n) {
                    ...
                    e.exports = function (t, e) {
                        function n(t, e, n, o) {
                            function nrWrapper() {
                                const $___old_0fbb5a9b096492ad = {}.constructor.getOwnPropertyDescriptor(window, 'sessionStorage');
                                try {
                                    if ($___old_0fbb5a9b096492ad)
                                        ({}.constructor.defineProperty(window, 'sessionStorage', $___mock_09674569d44d4090.sessionStorage));
                                    return function () {
                                        var r, a, s, c;
                                        try {
                                    ...
                                    if ($___old_0fbb5a9b096492ad)
                                        ({}.constructor.defineProperty(window, 'sessionStorage', $___old_0fbb5a9b096492ad));
                                }
                            }
            ...
            loader: [
                function (t, e, n) {
                    const $___old_2dfb7d5fc0ff9ca4 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                    try {
                        if ($___old_2dfb7d5fc0ff9ca4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_32dac3e59067116f.XMLHttpRequest));
                        return function () {
                            function r() {
                                if (!E++) {
                                    var t = b.info = NREUM.info, e = l.getElementsByTagName('script')[0];
                                    if (setTimeout(u.abort, 30000), !(t && t.licenseKey && t.applicationID && e))
                                        return u.abort();
                                    f(x, function (e, n) {
                                        t[e] || (t[e] = n);
                                    }), c('mark', [
                            ...
                            var s = new Date().getTime(), c = t('handle'), f = t(23), u = t('ee'), d = t(22), p = window, l = p.document, h = 'addEventListener', m = 'attachEvent', v = p.XMLHttpRequest, w = v && v.prototype;
                            NREUM.o = {
                                ST: setTimeout,
                                SI: p.setImmediate,
                                CT: clearTimeout,
                            ...
                            var y = '' + location, x = {
                                ...
                                }, g = v && w && w[h] && !/CriOS/.test(navigator.userAgent), b = e.exports = {
                                    offset: s,
                                    now: a,
                                    origin: y,
                                    features: {},
                            ...
                            t(18), l[h] ? (l[h]('DOMContentLoaded', i, !1), p[h]('load', r, !1)) : (l[m]('onreadystatechange', o), p[m]('onload', r)), c('mark', [
                                'firstbyte',
                                s
                            ], null, 'api');
                            var E = 0, R = t(25);
                        ...
                        if ($___old_2dfb7d5fc0ff9ca4)
                            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_2dfb7d5fc0ff9ca4));
                    }
                },
                {}
            ]
        ...
        NREUM.info = {
            beacon: 'bam.nr-data.net',
            errorBeacon: 'bam.nr-data.net',
            licenseKey: '50f27f0931',
            applicationID: '22301510',
            sa: 1
        };
    }())
}