var UET, UET_init, UET_push;
{
    ...
    (function () {
        ...
        UET_init = $___var_a817995abd3e4427;
        ...
        UET_push = $___var_7ad1f7ad7412cd2e;
        ...
        function $___var_284ac38ee207e2d3(o) {
            ...
            this.loadConfig = function () {
                const $___old_14566588eded35ef = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_b575276e71487501 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_14566588eded35ef)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_fc9417fe327c0a27.XMLHttpRequest));
                    if ($___old_b575276e71487501)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_fc9417fe327c0a27.XMLHttpRequest));
                    return function () {
                        var t, e, r, u, f, i, n;
                    ...
                    if ($___old_14566588eded35ef)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_14566588eded35ef));
                    if ($___old_b575276e71487501)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_b575276e71487501));
                }
            };
            this.push = function () {
            ...
            this.setLocalStorageBackup = function (n, t, i) {
                const $___old_4372afc7b978e1f1 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_4372afc7b978e1f1)
                    ...
                    if ($___old_4372afc7b978e1f1)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_4372afc7b978e1f1));
                }
            };
            this.getLocalStorageBackup = function (n, t) {
                const $___old_2da1943ef8739f45 = {}.constructor.getOwnPropertyDescriptor(window, 'localStorage');
                try {
                    if ($___old_2da1943ef8739f45)
                        ({}.constructor.defineProperty(window, 'localStorage', $___mock_e7790ddf33cecaea.localStorage));
                    return function () {
                        var r, i;
                        try {
                    ...
                    if ($___old_2da1943ef8739f45)
                        ({}.constructor.defineProperty(window, 'localStorage', $___old_2da1943ef8739f45));
                }
            };
