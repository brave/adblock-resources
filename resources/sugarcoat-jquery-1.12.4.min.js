{
    const $___mock_bcaab227e6e3e2c6 = {};
    (exports => {
        'use strict';
        const xhrUnsent = 0;
        const xhrOpened = 1;
    ...
    (function () {
        !function (a, b) {
            ...
            function hc() {
                const $___old_70d0ec2ef3f49bf1 = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest'), $___old_e950a6804fda03ca = {}.constructor.getOwnPropertyDescriptor(window, 'XMLHttpRequest');
                try {
                    if ($___old_70d0ec2ef3f49bf1)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bcaab227e6e3e2c6.XMLHttpRequest));
                    if ($___old_e950a6804fda03ca)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___mock_bcaab227e6e3e2c6.XMLHttpRequest));
                    return function () {
                        try {
                    ...
                    if ($___old_70d0ec2ef3f49bf1)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_70d0ec2ef3f49bf1));
                    if ($___old_e950a6804fda03ca)
                        ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_e950a6804fda03ca));
                }
            }
            function ic() {
                try {
